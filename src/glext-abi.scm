...
(define-extension-name GL_ARB_fragment_shader_interlock)
...
(define-extension-name GL_ARB_parallel_shader_compile)
...
(define-extension-name GL_ARB_polygon_offset_clamp)
(define-extension-name GL_ARB_post_depth_coverage)
...
(define-extension-name GL_ARB_sample_locations)
...
(define-extension-name GL_ARB_shader_atomic_counter_ops)
(define-extension-name GL_ARB_shader_atomic_counters)
(define-extension-name GL_ARB_shader_ballot)
(define-extension-name GL_ARB_shader_bit_encoding)
(define-extension-name GL_ARB_shader_clock)
...
(define-extension-name GL_ARB_shader_viewport_layer_array)
...
(define-extension-name GL_ARB_sparse_texture2)
(define-extension-name GL_ARB_sparse_texture_clamp)
(define-extension-name GL_ARB_spirv_extensions)
...
(define-extension-name GL_ARB_texture_filter_anisotropic)
(define-extension-name GL_ARB_texture_filter_minmax)
...
(define-extension-name GL_AMD_framebuffer_multisample_advanced)
(define-extension-name GL_AMD_framebuffer_sample_positions)
(define-extension-name GL_AMD_gcn_shader)
(define-extension-name GL_AMD_gpu_shader_half_float)
(define-extension-name GL_AMD_gpu_shader_int16)
...
(define-extension-name GL_AMD_shader_ballot)
(define-extension-name GL_AMD_shader_explicit_vertex_parameter)
(define-extension-name GL_AMD_shader_gpu_shader_half_float_fetch)
(define-extension-name GL_AMD_shader_image_load_store_lod)
...
(define-extension-name GL_AMD_texture_gather_bias_lod)
...
(define-extension-name GL_EXT_EGL_image_storage)
(define-extension-name GL_EXT_EGL_sync)
...
(define-extension-name GL_EXT_external_buffer)
(define-extension-name GL_EXT_fog_coord)
(define-extension-name GL_EXT_framebuffer_blit)
(define-extension-name GL_EXT_framebuffer_blit_layers)
...
(define-extension-name GL_EXT_memory_object)
(define-extension-name GL_EXT_memory_object_fd)
(define-extension-name GL_EXT_memory_object_win32)
...
(define-extension-name GL_EXT_multiview_tessellation_geometry_shader)
(define-extension-name GL_EXT_multiview_texture_multisample)
(define-extension-name GL_EXT_multiview_timer_query)
...
(define-extension-name GL_EXT_semaphore)
(define-extension-name GL_EXT_semaphore_fd)
(define-extension-name GL_EXT_semaphore_win32)
(define-extension-name GL_EXT_separate_shader_objects)
(define-extension-name GL_EXT_separate_specular_color)
(define-extension-name GL_EXT_shader_framebuffer_fetch)
(define-extension-name GL_EXT_shader_framebuffer_fetch_non_coherent)
...
(define-extension-name GL_EXT_shader_samples_identical)
...
(define-extension-name GL_EXT_texture_sRGB_R8)
(define-extension-name GL_EXT_texture_sRGB_RG8)
(define-extension-name GL_EXT_texture_sRGB_decode)
(define-extension-name GL_EXT_texture_shadow_lod)
(define-extension-name GL_EXT_texture_shared_exponent)
(define-extension-name GL_EXT_texture_snorm)
(define-extension-name GL_EXT_texture_storage)
...
(define-extension-name GL_EXT_win32_keyed_mutex)
(define-extension-name GL_EXT_window_rectangles)
...
(define-extension-name GL_INTEL_blackhole_render)
(define-extension-name GL_INTEL_conservative_rasterization)
(define-extension-name GL_INTEL_fragment_shader_ordering)
(define-extension-name GL_INTEL_framebuffer_CMAA)
...
(define-extension-name GL_MESA_framebuffer_flip_x)
(define-extension-name GL_MESA_framebuffer_flip_y)
(define-extension-name GL_MESA_framebuffer_swap_xy)
(define-extension-name GL_MESA_pack_invert)
(define-extension-name GL_MESA_program_binary_formats)
(define-extension-name GL_MESA_resize_buffers)
(define-extension-name GL_MESA_shader_integer_functions)
(define-extension-name GL_MESA_tile_raster_order)
(define-extension-name GL_MESA_window_pos)
(define-extension-name GL_MESA_ycbcr_texture)
(define-extension-name GL_NVX_blend_equation_advanced_multi_draw_buffers)
(define-extension-name GL_NVX_conditional_render)
(define-extension-name GL_NVX_gpu_memory_info)
(define-extension-name GL_NVX_gpu_multicast2)
(define-extension-name GL_NVX_linked_gpu_multicast)
(define-extension-name GL_NVX_progress_fence)
(define-extension-name GL_NV_alpha_to_coverage_dither_control)
...
(define-extension-name GL_NV_blend_minmax_factor)
(define-extension-name GL_NV_blend_square)
(define-extension-name GL_NV_clip_space_w_scaling)
(define-extension-name GL_NV_command_list)
(define-extension-name GL_NV_compute_program5)
(define-extension-name GL_NV_compute_shader_derivatives)
(define-extension-name GL_NV_conditional_render)
(define-extension-name GL_NV_conservative_raster)
(define-extension-name GL_NV_conservative_raster_dilate)
(define-extension-name GL_NV_conservative_raster_pre_snap)
(define-extension-name GL_NV_conservative_raster_pre_snap_triangles)
(define-extension-name GL_NV_conservative_raster_underestimation)
...
(define-extension-name GL_NV_draw_vulkan_image)
...
(define-extension-name GL_NV_fragment_shader_barycentric)
...
(define-extension-name GL_NV_gpu_multicast)
...
(define-extension-name GL_NV_memory_attachment)
(define-extension-name GL_NV_memory_object_sparse)
(define-extension-name GL_NV_mesh_shader)
...
(define-extension-name GL_NV_primitive_shading_rate)
(define-extension-name GL_NV_query_resource)
(define-extension-name GL_NV_query_resource_tag)
(define-extension-name GL_NV_register_combiners)
(define-extension-name GL_NV_register_combiners2)
(define-extension-name GL_NV_representative_fragment_test)
(define-extension-name GL_NV_robustness_video_memory_purge)
(define-extension-name GL_NV_sample_locations)
(define-extension-name GL_NV_sample_mask_override_coverage)
(define-extension-name GL_NV_scissor_exclusive)
(define-extension-name GL_NV_shader_atomic_counters)
(define-extension-name GL_NV_shader_atomic_float)
(define-extension-name GL_NV_shader_atomic_float64)
...
(define-extension-name GL_NV_shader_subgroup_partitioned)
(define-extension-name GL_NV_shader_texture_footprint)
(define-extension-name GL_NV_shader_thread_group)
(define-extension-name GL_NV_shader_thread_shuffle)
(define-extension-name GL_NV_shading_rate_image)
(define-extension-name GL_NV_stereo_view_rendering)
...
(define-extension-name GL_NV_texture_rectangle_compressed)
...
(define-extension-name GL_NV_timeline_semaphore)
...
(define-extension-name GL_NV_vdpau_interop2)
...
(define-extension-name GL_NV_viewport_array2)
(define-extension-name GL_NV_viewport_swizzle)
(define-extension-name GL_OML_interlace)
(define-extension-name GL_OML_resample)
(define-extension-name GL_OML_subsample)
(define-extension-name GL_OVR_multiview)
(define-extension-name GL_OVR_multiview2)
...
(define-constant GL_GLEXT_VERSION #x134b0a5)
...
(define-constant GL_COLOR_ATTACHMENT16 #x8cf0)
(define-constant GL_COLOR_ATTACHMENT17 #x8cf1)
(define-constant GL_COLOR_ATTACHMENT18 #x8cf2)
(define-constant GL_COLOR_ATTACHMENT19 #x8cf3)
(define-constant GL_COLOR_ATTACHMENT20 #x8cf4)
(define-constant GL_COLOR_ATTACHMENT21 #x8cf5)
(define-constant GL_COLOR_ATTACHMENT22 #x8cf6)
(define-constant GL_COLOR_ATTACHMENT23 #x8cf7)
(define-constant GL_COLOR_ATTACHMENT24 #x8cf8)
(define-constant GL_COLOR_ATTACHMENT25 #x8cf9)
(define-constant GL_COLOR_ATTACHMENT26 #x8cfa)
(define-constant GL_COLOR_ATTACHMENT27 #x8cfb)
(define-constant GL_COLOR_ATTACHMENT28 #x8cfc)
(define-constant GL_COLOR_ATTACHMENT29 #x8cfd)
(define-constant GL_COLOR_ATTACHMENT30 #x8cfe)
(define-constant GL_COLOR_ATTACHMENT31 #x8cff)
...
(define-constant GL_SHADER_BINARY_FORMAT_SPIR_V #x9551)
(define-constant GL_SPIR_V_BINARY #x9552)
(define-constant GL_PARAMETER_BUFFER #x80ee)
(define-constant GL_PARAMETER_BUFFER_BINDING #x80ef)
(define-constant GL_CONTEXT_FLAG_NO_ERROR_BIT #x0008)
(define-constant GL_VERTICES_SUBMITTED #x82ee)
(define-constant GL_PRIMITIVES_SUBMITTED #x82ef)
(define-constant GL_VERTEX_SHADER_INVOCATIONS #x82f0)
(define-constant GL_TESS_CONTROL_SHADER_PATCHES #x82f1)
(define-constant GL_TESS_EVALUATION_SHADER_INVOCATIONS #x82f2)
(define-constant GL_GEOMETRY_SHADER_PRIMITIVES_EMITTED #x82f3)
(define-constant GL_FRAGMENT_SHADER_INVOCATIONS #x82f4)
(define-constant GL_COMPUTE_SHADER_INVOCATIONS #x82f5)
(define-constant GL_CLIPPING_INPUT_PRIMITIVES #x82f6)
(define-constant GL_CLIPPING_OUTPUT_PRIMITIVES #x82f7)
(define-constant GL_POLYGON_OFFSET_CLAMP #x8e1b)
(define-constant GL_SPIR_V_EXTENSIONS #x9553)
(define-constant GL_NUM_SPIR_V_EXTENSIONS #x9554)
(define-constant GL_TEXTURE_MAX_ANISOTROPY #x84fe)
(define-constant GL_MAX_TEXTURE_MAX_ANISOTROPY #x84ff)
(define-constant GL_TRANSFORM_FEEDBACK_OVERFLOW #x82ec)
(define-constant GL_TRANSFORM_FEEDBACK_STREAM_OVERFLOW #x82ed)
(define-constant GL_PRIMITIVE_BOUNDING_BOX_ARB #x92be)
(define-constant GL_MULTISAMPLE_LINE_WIDTH_RANGE_ARB #x9381)
(define-constant GL_MULTISAMPLE_LINE_WIDTH_GRANULARITY_ARB #x9382)
...
(define-constant GL_SHADER_BINARY_FORMAT_SPIR_V_ARB #x9551)
(define-constant GL_SPIR_V_BINARY_ARB #x9552)
(define-constant GL_INT64_ARB #x140e)
(define-constant GL_INT64_VEC2_ARB #x8fe9)
(define-constant GL_INT64_VEC3_ARB #x8fea)
(define-constant GL_INT64_VEC4_ARB #x8feb)
(define-constant GL_UNSIGNED_INT64_VEC2_ARB #x8ff5)
(define-constant GL_UNSIGNED_INT64_VEC3_ARB #x8ff6)
(define-constant GL_UNSIGNED_INT64_VEC4_ARB #x8ff7)
...
(define-constant GL_VIEW_CLASS_EAC_R11 #x9383)
(define-constant GL_VIEW_CLASS_EAC_RG11 #x9384)
(define-constant GL_VIEW_CLASS_ETC2_RGB #x9385)
(define-constant GL_VIEW_CLASS_ETC2_RGBA #x9386)
(define-constant GL_VIEW_CLASS_ETC2_EAC_RGBA #x9387)
(define-constant GL_VIEW_CLASS_ASTC_4x4_RGBA #x9388)
(define-constant GL_VIEW_CLASS_ASTC_5x4_RGBA #x9389)
(define-constant GL_VIEW_CLASS_ASTC_5x5_RGBA #x938a)
(define-constant GL_VIEW_CLASS_ASTC_6x5_RGBA #x938b)
(define-constant GL_VIEW_CLASS_ASTC_6x6_RGBA #x938c)
(define-constant GL_VIEW_CLASS_ASTC_8x5_RGBA #x938d)
(define-constant GL_VIEW_CLASS_ASTC_8x6_RGBA #x938e)
(define-constant GL_VIEW_CLASS_ASTC_8x8_RGBA #x938f)
(define-constant GL_VIEW_CLASS_ASTC_10x5_RGBA #x9390)
(define-constant GL_VIEW_CLASS_ASTC_10x6_RGBA #x9391)
(define-constant GL_VIEW_CLASS_ASTC_10x8_RGBA #x9392)
(define-constant GL_VIEW_CLASS_ASTC_10x10_RGBA #x9393)
(define-constant GL_VIEW_CLASS_ASTC_12x10_RGBA #x9394)
(define-constant GL_VIEW_CLASS_ASTC_12x12_RGBA #x9395)
...
(define-constant GL_MAX_SHADER_COMPILER_THREADS_ARB #x91b0)
(define-constant GL_COMPLETION_STATUS_ARB #x91b1)
...
(define-constant GL_SAMPLE_LOCATION_SUBPIXEL_BITS_ARB #x933d)
(define-constant GL_SAMPLE_LOCATION_PIXEL_GRID_WIDTH_ARB #x933e)
(define-constant GL_SAMPLE_LOCATION_PIXEL_GRID_HEIGHT_ARB #x933f)
(define-constant GL_PROGRAMMABLE_SAMPLE_LOCATION_TABLE_SIZE_ARB #x9340)
(define-constant GL_SAMPLE_LOCATION_ARB #x8e50)
(define-constant GL_PROGRAMMABLE_SAMPLE_LOCATION_ARB #x9341)
(define-constant GL_FRAMEBUFFER_PROGRAMMABLE_SAMPLE_LOCATIONS_ARB #x9342)
(define-constant GL_FRAMEBUFFER_SAMPLE_LOCATION_PIXEL_GRID_ARB #x9343)
...
(define-constant GL_TEXTURE_REDUCTION_MODE_ARB #x9366)
(define-constant GL_WEIGHTED_AVERAGE_ARB #x9367)
...
(define-constant GL_CONTEXT_FLAG_NO_ERROR_BIT_KHR #x0008)
(define-constant GL_MAX_SHADER_COMPILER_THREADS_KHR #x91b0)
(define-constant GL_COMPLETION_STATUS_KHR #x91b1)
(define-constant GL_CONTEXT_ROBUST_ACCESS #x90f3)
(define-constant GL_SUBGROUP_SIZE_KHR #x9532)
(define-constant GL_SUBGROUP_SUPPORTED_STAGES_KHR #x9533)
(define-constant GL_SUBGROUP_SUPPORTED_FEATURES_KHR #x9534)
(define-constant GL_SUBGROUP_QUAD_ALL_STAGES_KHR #x9535)
(define-constant GL_SUBGROUP_FEATURE_BASIC_BIT_KHR #x0001)
(define-constant GL_SUBGROUP_FEATURE_VOTE_BIT_KHR #x0002)
(define-constant GL_SUBGROUP_FEATURE_ARITHMETIC_BIT_KHR #x0004)
(define-constant GL_SUBGROUP_FEATURE_BALLOT_BIT_KHR #x0008)
(define-constant GL_SUBGROUP_FEATURE_SHUFFLE_BIT_KHR #x0010)
(define-constant GL_SUBGROUP_FEATURE_SHUFFLE_RELATIVE_BIT_KHR #x0020)
(define-constant GL_SUBGROUP_FEATURE_CLUSTERED_BIT_KHR #x0040)
(define-constant GL_SUBGROUP_FEATURE_QUAD_BIT_KHR #x0080)
...
(define-constant GL_RENDERBUFFER_STORAGE_SAMPLES_AMD #x91b2)
(define-constant GL_MAX_COLOR_FRAMEBUFFER_SAMPLES_AMD #x91b3)
(define-constant GL_MAX_COLOR_FRAMEBUFFER_STORAGE_SAMPLES_AMD #x91b4)
(define-constant GL_MAX_DEPTH_STENCIL_FRAMEBUFFER_SAMPLES_AMD #x91b5)
(define-constant GL_NUM_SUPPORTED_MULTISAMPLE_MODES_AMD #x91b6)
(define-constant GL_SUPPORTED_MULTISAMPLE_MODES_AMD #x91b7)
(define-constant GL_SUBSAMPLE_DISTANCE_AMD #x883f)
(define-constant GL_PIXELS_PER_SAMPLE_PATTERN_X_AMD #x91ae)
(define-constant GL_PIXELS_PER_SAMPLE_PATTERN_Y_AMD #x91af)
(define-constant GL_ALL_PIXELS_AMD #xffffffff)
...
(define-constant GL_FLOAT16_MAT2_AMD #x91c5)
(define-constant GL_FLOAT16_MAT3_AMD #x91c6)
(define-constant GL_FLOAT16_MAT4_AMD #x91c7)
(define-constant GL_FLOAT16_MAT2x3_AMD #x91c8)
(define-constant GL_FLOAT16_MAT2x4_AMD #x91c9)
(define-constant GL_FLOAT16_MAT3x2_AMD #x91ca)
(define-constant GL_FLOAT16_MAT3x4_AMD #x91cb)
(define-constant GL_FLOAT16_MAT4x2_AMD #x91cc)
(define-constant GL_FLOAT16_MAT4x3_AMD #x91cd)
...
(define-constant GL_TEXTURE_TILING_EXT #x9580)
(define-constant GL_DEDICATED_MEMORY_OBJECT_EXT #x9581)
(define-constant GL_PROTECTED_MEMORY_OBJECT_EXT #x959b)
(define-constant GL_NUM_TILING_TYPES_EXT #x9582)
(define-constant GL_TILING_TYPES_EXT #x9583)
(define-constant GL_OPTIMAL_TILING_EXT #x9584)
(define-constant GL_LINEAR_TILING_EXT #x9585)
(define-constant GL_NUM_DEVICE_UUIDS_EXT #x9596)
(define-constant GL_DEVICE_UUID_EXT #x9597)
(define-constant GL_DRIVER_UUID_EXT #x9598)
(define-constant GL_UUID_SIZE_EXT #x0010)
(define-constant GL_HANDLE_TYPE_OPAQUE_FD_EXT #x9586)
(define-constant GL_HANDLE_TYPE_OPAQUE_WIN32_EXT #x9587)
(define-constant GL_HANDLE_TYPE_OPAQUE_WIN32_KMT_EXT #x9588)
(define-constant GL_DEVICE_LUID_EXT #x9599)
(define-constant GL_DEVICE_NODE_MASK_EXT #x959a)
(define-constant GL_LUID_SIZE_EXT #x0008)
(define-constant GL_HANDLE_TYPE_D3D12_TILEPOOL_EXT #x9589)
(define-constant GL_HANDLE_TYPE_D3D12_RESOURCE_EXT #x958a)
(define-constant GL_HANDLE_TYPE_D3D11_IMAGE_EXT #x958b)
(define-constant GL_HANDLE_TYPE_D3D11_IMAGE_KMT_EXT #x958c)
...
(define-constant GL_LAYOUT_GENERAL_EXT #x958d)
(define-constant GL_LAYOUT_COLOR_ATTACHMENT_EXT #x958e)
(define-constant GL_LAYOUT_DEPTH_STENCIL_ATTACHMENT_EXT #x958f)
(define-constant GL_LAYOUT_DEPTH_STENCIL_READ_ONLY_EXT #x9590)
(define-constant GL_LAYOUT_SHADER_READ_ONLY_EXT #x9591)
(define-constant GL_LAYOUT_TRANSFER_SRC_EXT #x9592)
(define-constant GL_LAYOUT_TRANSFER_DST_EXT #x9593)
(define-constant GL_LAYOUT_DEPTH_READ_ONLY_STENCIL_ATTACHMENT_EXT #x9530)
(define-constant GL_LAYOUT_DEPTH_ATTACHMENT_STENCIL_READ_ONLY_EXT #x9531)
(define-constant GL_HANDLE_TYPE_D3D12_FENCE_EXT #x9594)
(define-constant GL_D3D12_FENCE_VALUE_EXT #x9595)
...
(define-constant GL_FRAGMENT_SHADER_DISCARDS_SAMPLES_EXT #x8a52)
...
(define-constant GL_TEXTURE_REDUCTION_MODE_EXT #x9366)
(define-constant GL_WEIGHTED_AVERAGE_EXT #x9367)
...
(define-constant GL_SR8_EXT #x8fbd)
(define-constant GL_SRG8_EXT #x8fbe)
...
(define-constant GL_TEXTURE_IMMUTABLE_FORMAT_EXT #x912f)
(define-constant GL_RGBA32F_EXT #x8814)
(define-constant GL_RGB32F_EXT #x8815)
(define-constant GL_ALPHA32F_EXT #x8816)
(define-constant GL_LUMINANCE32F_EXT #x8818)
(define-constant GL_LUMINANCE_ALPHA32F_EXT #x8819)
(define-constant GL_RGBA16F_EXT #x881a)
(define-constant GL_RGB16F_EXT #x881b)
(define-constant GL_ALPHA16F_EXT #x881c)
(define-constant GL_LUMINANCE16F_EXT #x881e)
(define-constant GL_LUMINANCE_ALPHA16F_EXT #x881f)
(define-constant GL_BGRA8_EXT #x93a1)
(define-constant GL_R8_EXT #x8229)
(define-constant GL_RG8_EXT #x822b)
(define-constant GL_R32F_EXT #x822e)
(define-constant GL_RG32F_EXT #x8230)
(define-constant GL_R16F_EXT #x822d)
(define-constant GL_RG16F_EXT #x822f)
...
(define-constant GL_INCLUSIVE_EXT #x8f10)
(define-constant GL_EXCLUSIVE_EXT #x8f11)
(define-constant GL_WINDOW_RECTANGLE_EXT #x8f12)
(define-constant GL_WINDOW_RECTANGLE_MODE_EXT #x8f13)
(define-constant GL_MAX_WINDOW_RECTANGLES_EXT #x8f14)
(define-constant GL_NUM_WINDOW_RECTANGLES_EXT #x8f15)
...
(define-constant GL_BLACKHOLE_RENDER_INTEL #x83fc)
(define-constant GL_CONSERVATIVE_RASTERIZATION_INTEL #x83fe)
...
(define-constant GL_FRAMEBUFFER_FLIP_X_MESA #x8bbc)
(define-constant GL_FRAMEBUFFER_FLIP_Y_MESA #x8bbb)
(define-constant GL_FRAMEBUFFER_SWAP_XY_MESA #x8bbd)
(define-constant GL_PACK_INVERT_MESA #x8758)
(define-constant GL_PROGRAM_BINARY_FORMAT_MESA #x875f)
(define-constant GL_TILE_RASTER_ORDER_FIXED_MESA #x8bb8)
(define-constant GL_TILE_RASTER_ORDER_INCREASING_X_MESA #x8bb9)
(define-constant GL_TILE_RASTER_ORDER_INCREASING_Y_MESA #x8bba)
...
(define-constant GL_UPLOAD_GPU_MASK_NVX #x954a)
(define-constant GL_LGPU_SEPARATE_STORAGE_BIT_NVX #x0800)
(define-constant GL_MAX_LGPU_GPUS_NVX #x92ba)
(define-constant GL_ALPHA_TO_COVERAGE_DITHER_DEFAULT_NV #x934d)
(define-constant GL_ALPHA_TO_COVERAGE_DITHER_ENABLE_NV #x934e)
(define-constant GL_ALPHA_TO_COVERAGE_DITHER_DISABLE_NV #x934f)
(define-constant GL_ALPHA_TO_COVERAGE_DITHER_MODE_NV #x92bf)
...
(define-constant GL_VIEWPORT_POSITION_W_SCALE_NV #x937c)
(define-constant GL_VIEWPORT_POSITION_W_SCALE_X_COEFF_NV #x937d)
(define-constant GL_VIEWPORT_POSITION_W_SCALE_Y_COEFF_NV #x937e)
(define-constant GL_TERMINATE_SEQUENCE_COMMAND_NV #x0000)
(define-constant GL_NOP_COMMAND_NV #x0001)
(define-constant GL_DRAW_ELEMENTS_COMMAND_NV #x0002)
(define-constant GL_DRAW_ARRAYS_COMMAND_NV #x0003)
(define-constant GL_DRAW_ELEMENTS_STRIP_COMMAND_NV #x0004)
(define-constant GL_DRAW_ARRAYS_STRIP_COMMAND_NV #x0005)
(define-constant GL_DRAW_ELEMENTS_INSTANCED_COMMAND_NV #x0006)
(define-constant GL_DRAW_ARRAYS_INSTANCED_COMMAND_NV #x0007)
(define-constant GL_ELEMENT_ADDRESS_COMMAND_NV #x0008)
(define-constant GL_ATTRIBUTE_ADDRESS_COMMAND_NV #x0009)
(define-constant GL_UNIFORM_ADDRESS_COMMAND_NV #x000a)
(define-constant GL_BLEND_COLOR_COMMAND_NV #x000b)
(define-constant GL_STENCIL_REF_COMMAND_NV #x000c)
(define-constant GL_LINE_WIDTH_COMMAND_NV #x000d)
(define-constant GL_POLYGON_OFFSET_COMMAND_NV #x000e)
(define-constant GL_ALPHA_REF_COMMAND_NV #x000f)
(define-constant GL_VIEWPORT_COMMAND_NV #x0010)
(define-constant GL_SCISSOR_COMMAND_NV #x0011)
(define-constant GL_FRONT_FACE_COMMAND_NV #x0012)
...
(define-constant GL_CONSERVATIVE_RASTER_DILATE_NV #x9379)
(define-constant GL_CONSERVATIVE_RASTER_DILATE_RANGE_NV #x937a)
(define-constant GL_CONSERVATIVE_RASTER_DILATE_GRANULARITY_NV #x937b)
(define-constant GL_CONSERVATIVE_RASTER_MODE_PRE_SNAP_NV #x9550)
(define-constant GL_CONSERVATIVE_RASTER_MODE_NV #x954d)
(define-constant GL_CONSERVATIVE_RASTER_MODE_POST_SNAP_NV #x954e)
(define-constant GL_CONSERVATIVE_RASTER_MODE_PRE_SNAP_TRIANGLES_NV #x954f)
...
(define-constant GL_PER_GPU_STORAGE_BIT_NV #x0800)
(define-constant GL_MULTICAST_GPUS_NV #x92ba)
(define-constant GL_RENDER_GPU_MASK_NV #x9558)
(define-constant GL_PER_GPU_STORAGE_NV #x9548)
(define-constant GL_MULTICAST_PROGRAMMABLE_SAMPLE_LOCATION_NV #x9549)
...
(define-constant GL_ATTACHED_MEMORY_OBJECT_NV #x95a4)
(define-constant GL_ATTACHED_MEMORY_OFFSET_NV #x95a5)
(define-constant GL_MEMORY_ATTACHABLE_ALIGNMENT_NV #x95a6)
(define-constant GL_MEMORY_ATTACHABLE_SIZE_NV #x95a7)
(define-constant GL_MEMORY_ATTACHABLE_NV #x95a8)
(define-constant GL_DETACHED_MEMORY_INCARNATION_NV #x95a9)
(define-constant GL_DETACHED_TEXTURES_NV #x95aa)
(define-constant GL_DETACHED_BUFFERS_NV #x95ab)
(define-constant GL_MAX_DETACHED_TEXTURES_NV #x95ac)
(define-constant GL_MAX_DETACHED_BUFFERS_NV #x95ad)
(define-constant GL_MESH_SHADER_NV #x9559)
(define-constant GL_TASK_SHADER_NV #x955a)
(define-constant GL_MAX_MESH_UNIFORM_BLOCKS_NV #x8e60)
(define-constant GL_MAX_MESH_TEXTURE_IMAGE_UNITS_NV #x8e61)
(define-constant GL_MAX_MESH_IMAGE_UNIFORMS_NV #x8e62)
(define-constant GL_MAX_MESH_UNIFORM_COMPONENTS_NV #x8e63)
(define-constant GL_MAX_MESH_ATOMIC_COUNTER_BUFFERS_NV #x8e64)
(define-constant GL_MAX_MESH_ATOMIC_COUNTERS_NV #x8e65)
(define-constant GL_MAX_MESH_SHADER_STORAGE_BLOCKS_NV #x8e66)
(define-constant GL_MAX_COMBINED_MESH_UNIFORM_COMPONENTS_NV #x8e67)
(define-constant GL_MAX_TASK_UNIFORM_BLOCKS_NV #x8e68)
(define-constant GL_MAX_TASK_TEXTURE_IMAGE_UNITS_NV #x8e69)
(define-constant GL_MAX_TASK_IMAGE_UNIFORMS_NV #x8e6a)
(define-constant GL_MAX_TASK_UNIFORM_COMPONENTS_NV #x8e6b)
(define-constant GL_MAX_TASK_ATOMIC_COUNTER_BUFFERS_NV #x8e6c)
(define-constant GL_MAX_TASK_ATOMIC_COUNTERS_NV #x8e6d)
(define-constant GL_MAX_TASK_SHADER_STORAGE_BLOCKS_NV #x8e6e)
(define-constant GL_MAX_COMBINED_TASK_UNIFORM_COMPONENTS_NV #x8e6f)
(define-constant GL_MAX_MESH_WORK_GROUP_INVOCATIONS_NV #x95a2)
(define-constant GL_MAX_TASK_WORK_GROUP_INVOCATIONS_NV #x95a3)
(define-constant GL_MAX_MESH_TOTAL_MEMORY_SIZE_NV #x9536)
(define-constant GL_MAX_TASK_TOTAL_MEMORY_SIZE_NV #x9537)
(define-constant GL_MAX_MESH_OUTPUT_VERTICES_NV #x9538)
(define-constant GL_MAX_MESH_OUTPUT_PRIMITIVES_NV #x9539)
(define-constant GL_MAX_TASK_OUTPUT_COUNT_NV #x953a)
(define-constant GL_MAX_DRAW_MESH_TASKS_COUNT_NV #x953d)
(define-constant GL_MAX_MESH_VIEWS_NV #x9557)
(define-constant GL_MESH_OUTPUT_PER_VERTEX_GRANULARITY_NV #x92df)
(define-constant GL_MESH_OUTPUT_PER_PRIMITIVE_GRANULARITY_NV #x9543)
(define-constant GL_MAX_MESH_WORK_GROUP_SIZE_NV #x953b)
(define-constant GL_MAX_TASK_WORK_GROUP_SIZE_NV #x953c)
(define-constant GL_MESH_WORK_GROUP_SIZE_NV #x953e)
(define-constant GL_TASK_WORK_GROUP_SIZE_NV #x953f)
(define-constant GL_MESH_VERTICES_OUT_NV #x9579)
(define-constant GL_MESH_PRIMITIVES_OUT_NV #x957a)
(define-constant GL_MESH_OUTPUT_TYPE_NV #x957b)
(define-constant GL_UNIFORM_BLOCK_REFERENCED_BY_MESH_SHADER_NV #x959c)
(define-constant GL_UNIFORM_BLOCK_REFERENCED_BY_TASK_SHADER_NV #x959d)
(define-constant GL_REFERENCED_BY_MESH_SHADER_NV #x95a0)
(define-constant GL_REFERENCED_BY_TASK_SHADER_NV #x95a1)
(define-constant GL_MESH_SHADER_BIT_NV #x0040)
(define-constant GL_TASK_SHADER_BIT_NV #x0080)
(define-constant GL_MESH_SUBROUTINE_NV #x957c)
(define-constant GL_TASK_SUBROUTINE_NV #x957d)
(define-constant GL_MESH_SUBROUTINE_UNIFORM_NV #x957e)
(define-constant GL_TASK_SUBROUTINE_UNIFORM_NV #x957f)
(define-constant GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_MESH_SHADER_NV #x959e)
(define-constant GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_TASK_SHADER_NV #x959f)
...
(define-constant GL_SHADING_RATE_IMAGE_PER_PRIMITIVE_NV #x95b1)
(define-constant GL_SHADING_RATE_IMAGE_PALETTE_COUNT_NV #x95b2)
(define-constant GL_QUERY_RESOURCE_TYPE_VIDMEM_ALLOC_NV #x9540)
(define-constant GL_QUERY_RESOURCE_MEMTYPE_VIDMEM_NV #x9542)
(define-constant GL_QUERY_RESOURCE_SYS_RESERVED_NV #x9544)
(define-constant GL_QUERY_RESOURCE_TEXTURE_NV #x9545)
(define-constant GL_QUERY_RESOURCE_RENDERBUFFER_NV #x9546)
(define-constant GL_QUERY_RESOURCE_BUFFEROBJECT_NV #x9547)
...
(define-constant GL_REPRESENTATIVE_FRAGMENT_TEST_NV #x937f)
(define-constant GL_PURGED_CONTEXT_RESET_NV #x92bb)
...
(define-constant GL_SCISSOR_TEST_EXCLUSIVE_NV #x9555)
(define-constant GL_SCISSOR_BOX_EXCLUSIVE_NV #x9556)
...
(define-constant GL_SUBGROUP_FEATURE_PARTITIONED_BIT_NV #x0100)
(define-constant GL_WARP_SIZE_NV #x9339)
(define-constant GL_WARPS_PER_SM_NV #x933a)
(define-constant GL_SM_COUNT_NV #x933b)
(define-constant GL_SHADING_RATE_IMAGE_NV #x9563)
(define-constant GL_SHADING_RATE_NO_INVOCATIONS_NV #x9564)
(define-constant GL_SHADING_RATE_1_INVOCATION_PER_PIXEL_NV #x9565)
(define-constant GL_SHADING_RATE_1_INVOCATION_PER_1X2_PIXELS_NV #x9566)
(define-constant GL_SHADING_RATE_1_INVOCATION_PER_2X1_PIXELS_NV #x9567)
(define-constant GL_SHADING_RATE_1_INVOCATION_PER_2X2_PIXELS_NV #x9568)
(define-constant GL_SHADING_RATE_1_INVOCATION_PER_2X4_PIXELS_NV #x9569)
(define-constant GL_SHADING_RATE_1_INVOCATION_PER_4X2_PIXELS_NV #x956a)
(define-constant GL_SHADING_RATE_1_INVOCATION_PER_4X4_PIXELS_NV #x956b)
(define-constant GL_SHADING_RATE_2_INVOCATIONS_PER_PIXEL_NV #x956c)
(define-constant GL_SHADING_RATE_4_INVOCATIONS_PER_PIXEL_NV #x956d)
(define-constant GL_SHADING_RATE_8_INVOCATIONS_PER_PIXEL_NV #x956e)
(define-constant GL_SHADING_RATE_16_INVOCATIONS_PER_PIXEL_NV #x956f)
(define-constant GL_SHADING_RATE_IMAGE_BINDING_NV #x955b)
(define-constant GL_SHADING_RATE_IMAGE_TEXEL_WIDTH_NV #x955c)
(define-constant GL_SHADING_RATE_IMAGE_TEXEL_HEIGHT_NV #x955d)
(define-constant GL_SHADING_RATE_IMAGE_PALETTE_SIZE_NV #x955e)
(define-constant GL_MAX_COARSE_FRAGMENT_SAMPLES_NV #x955f)
(define-constant GL_SHADING_RATE_SAMPLE_ORDER_DEFAULT_NV #x95ae)
(define-constant GL_SHADING_RATE_SAMPLE_ORDER_PIXEL_MAJOR_NV #x95af)
(define-constant GL_SHADING_RATE_SAMPLE_ORDER_SAMPLE_MAJOR_NV #x95b0)
...
(define-constant GL_TIMELINE_SEMAPHORE_VALUE_NV #x9595)
(define-constant GL_SEMAPHORE_TYPE_NV #x95b3)
(define-constant GL_SEMAPHORE_TYPE_BINARY_NV #x95b4)
(define-constant GL_SEMAPHORE_TYPE_TIMELINE_NV #x95b5)
(define-constant GL_MAX_TIMELINE_SEMAPHORE_VALUE_DIFFERENCE_NV #x95b6)
...
(define-constant GL_VIEWPORT_SWIZZLE_POSITIVE_X_NV #x9350)
(define-constant GL_VIEWPORT_SWIZZLE_NEGATIVE_X_NV #x9351)
(define-constant GL_VIEWPORT_SWIZZLE_POSITIVE_Y_NV #x9352)
(define-constant GL_VIEWPORT_SWIZZLE_NEGATIVE_Y_NV #x9353)
(define-constant GL_VIEWPORT_SWIZZLE_POSITIVE_Z_NV #x9354)
(define-constant GL_VIEWPORT_SWIZZLE_NEGATIVE_Z_NV #x9355)
(define-constant GL_VIEWPORT_SWIZZLE_POSITIVE_W_NV #x9356)
(define-constant GL_VIEWPORT_SWIZZLE_NEGATIVE_W_NV #x9357)
(define-constant GL_VIEWPORT_SWIZZLE_X_NV #x9358)
(define-constant GL_VIEWPORT_SWIZZLE_Y_NV #x9359)
(define-constant GL_VIEWPORT_SWIZZLE_Z_NV #x935a)
(define-constant GL_VIEWPORT_SWIZZLE_W_NV #x935b)
...
(define-constant GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_NUM_VIEWS_OVR #x9630)
(define-constant GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_BASE_VIEW_INDEX_OVR #x9632)
(define-constant GL_MAX_VIEWS_OVR #x9631)
(define-constant GL_FRAMEBUFFER_INCOMPLETE_VIEW_TARGETS_OVR #x9633)
...
(define-constant GL_PACK_RESAMPLE_SGIX #x842e)
(define-constant GL_UNPACK_RESAMPLE_SGIX #x842f)
(define-constant GL_RESAMPLE_REPLICATE_SGIX #x8433)
(define-constant GL_RESAMPLE_ZERO_FILL_SGIX #x8434)
...
(define-entry-point glGetSynciv PFNGLGETSYNCIVPROC "typedef void (APIENTRYP PFNGLGETSYNCIVPROC) (GLsync sync, GLenum pname, GLsizei count, GLsizei *length, GLint *values);")
...
(define-entry-point glGetInternalformativ PFNGLGETINTERNALFORMATIVPROC "typedef void (APIENTRYP PFNGLGETINTERNALFORMATIVPROC) (GLenum target, GLenum internalformat, GLenum pname, GLsizei count, GLint *params);")
...
(define-entry-point glGetInternalformati64v PFNGLGETINTERNALFORMATI64VPROC "typedef void (APIENTRYP PFNGLGETINTERNALFORMATI64VPROC) (GLenum target, GLenum internalformat, GLenum pname, GLsizei count, GLint64 *params);")
...
(define-entry-point glGetProgramResourceiv PFNGLGETPROGRAMRESOURCEIVPROC "typedef void (APIENTRYP PFNGLGETPROGRAMRESOURCEIVPROC) (GLuint program, GLenum programInterface, GLuint index, GLsizei propCount, const GLenum *props, GLsizei count, GLsizei *length, GLint *params);")
...
(define-entry-point glTransformFeedbackBufferRange PFNGLTRANSFORMFEEDBACKBUFFERRANGEPROC "typedef void (APIENTRYP PFNGLTRANSFORMFEEDBACKBUFFERRANGEPROC) (GLuint xfb, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size);")
...
(define-entry-point glNamedBufferStorage PFNGLNAMEDBUFFERSTORAGEPROC "typedef void (APIENTRYP PFNGLNAMEDBUFFERSTORAGEPROC) (GLuint buffer, GLsizeiptr size, const void *data, GLbitfield flags);")
(define-entry-point glNamedBufferData PFNGLNAMEDBUFFERDATAPROC "typedef void (APIENTRYP PFNGLNAMEDBUFFERDATAPROC) (GLuint buffer, GLsizeiptr size, const void *data, GLenum usage);")
(define-entry-point glNamedBufferSubData PFNGLNAMEDBUFFERSUBDATAPROC "typedef void (APIENTRYP PFNGLNAMEDBUFFERSUBDATAPROC) (GLuint buffer, GLintptr offset, GLsizeiptr size, const void *data);")
(define-entry-point glCopyNamedBufferSubData PFNGLCOPYNAMEDBUFFERSUBDATAPROC "typedef void (APIENTRYP PFNGLCOPYNAMEDBUFFERSUBDATAPROC) (GLuint readBuffer, GLuint writeBuffer, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size);")
...
(define-entry-point glClearNamedBufferSubData PFNGLCLEARNAMEDBUFFERSUBDATAPROC "typedef void (APIENTRYP PFNGLCLEARNAMEDBUFFERSUBDATAPROC) (GLuint buffer, GLenum internalformat, GLintptr offset, GLsizeiptr size, GLenum format, GLenum type, const void *data);")
...
(define-entry-point glMapNamedBufferRange PFNGLMAPNAMEDBUFFERRANGEPROC "typedef void *(APIENTRYP PFNGLMAPNAMEDBUFFERRANGEPROC) (GLuint buffer, GLintptr offset, GLsizeiptr length, GLbitfield access);")
...
(define-entry-point glFlushMappedNamedBufferRange PFNGLFLUSHMAPPEDNAMEDBUFFERRANGEPROC "typedef void (APIENTRYP PFNGLFLUSHMAPPEDNAMEDBUFFERRANGEPROC) (GLuint buffer, GLintptr offset, GLsizeiptr length);")
...
(define-entry-point glGetNamedBufferSubData PFNGLGETNAMEDBUFFERSUBDATAPROC "typedef void (APIENTRYP PFNGLGETNAMEDBUFFERSUBDATAPROC) (GLuint buffer, GLintptr offset, GLsizeiptr size, void *data);")
...
(define-entry-point glClearNamedFramebufferfi PFNGLCLEARNAMEDFRAMEBUFFERFIPROC "typedef void (APIENTRYP PFNGLCLEARNAMEDFRAMEBUFFERFIPROC) (GLuint framebuffer, GLenum buffer, GLint drawbuffer, GLfloat depth, GLint stencil);")
...
(define-entry-point glTextureBufferRange PFNGLTEXTUREBUFFERRANGEPROC "typedef void (APIENTRYP PFNGLTEXTUREBUFFERRANGEPROC) (GLuint texture, GLenum internalformat, GLuint buffer, GLintptr offset, GLsizeiptr size);")
...
(define-entry-point glSpecializeShader PFNGLSPECIALIZESHADERPROC "typedef void (APIENTRYP PFNGLSPECIALIZESHADERPROC) (GLuint shader, const GLchar *pEntryPoint, GLuint numSpecializationConstants, const GLuint *pConstantIndex, const GLuint *pConstantValue);")
(define-entry-point glMultiDrawArraysIndirectCount PFNGLMULTIDRAWARRAYSINDIRECTCOUNTPROC "typedef void (APIENTRYP PFNGLMULTIDRAWARRAYSINDIRECTCOUNTPROC) (GLenum mode, const void *indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride);")
(define-entry-point glMultiDrawElementsIndirectCount PFNGLMULTIDRAWELEMENTSINDIRECTCOUNTPROC "typedef void (APIENTRYP PFNGLMULTIDRAWELEMENTSINDIRECTCOUNTPROC) (GLenum mode, GLenum type, const void *indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride);")
(define-entry-point glPolygonOffsetClamp PFNGLPOLYGONOFFSETCLAMPPROC "typedef void (APIENTRYP PFNGLPOLYGONOFFSETCLAMPPROC) (GLfloat factor, GLfloat units, GLfloat clamp);")
(define-entry-point glPrimitiveBoundingBoxARB PFNGLPRIMITIVEBOUNDINGBOXARBPROC "typedef void (APIENTRYP PFNGLPRIMITIVEBOUNDINGBOXARBPROC) (GLfloat minX, GLfloat minY, GLfloat minZ, GLfloat minW, GLfloat maxX, GLfloat maxY, GLfloat maxZ, GLfloat maxW);")
...
(define-entry-point glSpecializeShaderARB PFNGLSPECIALIZESHADERARBPROC "typedef void (APIENTRYP PFNGLSPECIALIZESHADERARBPROC) (GLuint shader, const GLchar *pEntryPoint, GLuint numSpecializationConstants, const GLuint *pConstantIndex, const GLuint *pConstantValue);")
(define-entry-point glUniform1i64ARB PFNGLUNIFORM1I64ARBPROC "typedef void (APIENTRYP PFNGLUNIFORM1I64ARBPROC) (GLint location, GLint64 x);")
(define-entry-point glUniform2i64ARB PFNGLUNIFORM2I64ARBPROC "typedef void (APIENTRYP PFNGLUNIFORM2I64ARBPROC) (GLint location, GLint64 x, GLint64 y);")
(define-entry-point glUniform3i64ARB PFNGLUNIFORM3I64ARBPROC "typedef void (APIENTRYP PFNGLUNIFORM3I64ARBPROC) (GLint location, GLint64 x, GLint64 y, GLint64 z);")
(define-entry-point glUniform4i64ARB PFNGLUNIFORM4I64ARBPROC "typedef void (APIENTRYP PFNGLUNIFORM4I64ARBPROC) (GLint location, GLint64 x, GLint64 y, GLint64 z, GLint64 w);")
(define-entry-point glUniform1i64vARB PFNGLUNIFORM1I64VARBPROC "typedef void (APIENTRYP PFNGLUNIFORM1I64VARBPROC) (GLint location, GLsizei count, const GLint64 *value);")
(define-entry-point glUniform2i64vARB PFNGLUNIFORM2I64VARBPROC "typedef void (APIENTRYP PFNGLUNIFORM2I64VARBPROC) (GLint location, GLsizei count, const GLint64 *value);")
(define-entry-point glUniform3i64vARB PFNGLUNIFORM3I64VARBPROC "typedef void (APIENTRYP PFNGLUNIFORM3I64VARBPROC) (GLint location, GLsizei count, const GLint64 *value);")
(define-entry-point glUniform4i64vARB PFNGLUNIFORM4I64VARBPROC "typedef void (APIENTRYP PFNGLUNIFORM4I64VARBPROC) (GLint location, GLsizei count, const GLint64 *value);")
(define-entry-point glUniform1ui64ARB PFNGLUNIFORM1UI64ARBPROC "typedef void (APIENTRYP PFNGLUNIFORM1UI64ARBPROC) (GLint location, GLuint64 x);")
(define-entry-point glUniform2ui64ARB PFNGLUNIFORM2UI64ARBPROC "typedef void (APIENTRYP PFNGLUNIFORM2UI64ARBPROC) (GLint location, GLuint64 x, GLuint64 y);")
(define-entry-point glUniform3ui64ARB PFNGLUNIFORM3UI64ARBPROC "typedef void (APIENTRYP PFNGLUNIFORM3UI64ARBPROC) (GLint location, GLuint64 x, GLuint64 y, GLuint64 z);")
(define-entry-point glUniform4ui64ARB PFNGLUNIFORM4UI64ARBPROC "typedef void (APIENTRYP PFNGLUNIFORM4UI64ARBPROC) (GLint location, GLuint64 x, GLuint64 y, GLuint64 z, GLuint64 w);")
(define-entry-point glUniform1ui64vARB PFNGLUNIFORM1UI64VARBPROC "typedef void (APIENTRYP PFNGLUNIFORM1UI64VARBPROC) (GLint location, GLsizei count, const GLuint64 *value);")
(define-entry-point glUniform2ui64vARB PFNGLUNIFORM2UI64VARBPROC "typedef void (APIENTRYP PFNGLUNIFORM2UI64VARBPROC) (GLint location, GLsizei count, const GLuint64 *value);")
(define-entry-point glUniform3ui64vARB PFNGLUNIFORM3UI64VARBPROC "typedef void (APIENTRYP PFNGLUNIFORM3UI64VARBPROC) (GLint location, GLsizei count, const GLuint64 *value);")
(define-entry-point glUniform4ui64vARB PFNGLUNIFORM4UI64VARBPROC "typedef void (APIENTRYP PFNGLUNIFORM4UI64VARBPROC) (GLint location, GLsizei count, const GLuint64 *value);")
(define-entry-point glGetUniformi64vARB PFNGLGETUNIFORMI64VARBPROC "typedef void (APIENTRYP PFNGLGETUNIFORMI64VARBPROC) (GLuint program, GLint location, GLint64 *params);")
(define-entry-point glGetUniformui64vARB PFNGLGETUNIFORMUI64VARBPROC "typedef void (APIENTRYP PFNGLGETUNIFORMUI64VARBPROC) (GLuint program, GLint location, GLuint64 *params);")
(define-entry-point glGetnUniformi64vARB PFNGLGETNUNIFORMI64VARBPROC "typedef void (APIENTRYP PFNGLGETNUNIFORMI64VARBPROC) (GLuint program, GLint location, GLsizei bufSize, GLint64 *params);")
(define-entry-point glGetnUniformui64vARB PFNGLGETNUNIFORMUI64VARBPROC "typedef void (APIENTRYP PFNGLGETNUNIFORMUI64VARBPROC) (GLuint program, GLint location, GLsizei bufSize, GLuint64 *params);")
(define-entry-point glProgramUniform1i64ARB PFNGLPROGRAMUNIFORM1I64ARBPROC "typedef void (APIENTRYP PFNGLPROGRAMUNIFORM1I64ARBPROC) (GLuint program, GLint location, GLint64 x);")
(define-entry-point glProgramUniform2i64ARB PFNGLPROGRAMUNIFORM2I64ARBPROC "typedef void (APIENTRYP PFNGLPROGRAMUNIFORM2I64ARBPROC) (GLuint program, GLint location, GLint64 x, GLint64 y);")
(define-entry-point glProgramUniform3i64ARB PFNGLPROGRAMUNIFORM3I64ARBPROC "typedef void (APIENTRYP PFNGLPROGRAMUNIFORM3I64ARBPROC) (GLuint program, GLint location, GLint64 x, GLint64 y, GLint64 z);")
(define-entry-point glProgramUniform4i64ARB PFNGLPROGRAMUNIFORM4I64ARBPROC "typedef void (APIENTRYP PFNGLPROGRAMUNIFORM4I64ARBPROC) (GLuint program, GLint location, GLint64 x, GLint64 y, GLint64 z, GLint64 w);")
(define-entry-point glProgramUniform1i64vARB PFNGLPROGRAMUNIFORM1I64VARBPROC "typedef void (APIENTRYP PFNGLPROGRAMUNIFORM1I64VARBPROC) (GLuint program, GLint location, GLsizei count, const GLint64 *value);")
(define-entry-point glProgramUniform2i64vARB PFNGLPROGRAMUNIFORM2I64VARBPROC "typedef void (APIENTRYP PFNGLPROGRAMUNIFORM2I64VARBPROC) (GLuint program, GLint location, GLsizei count, const GLint64 *value);")
(define-entry-point glProgramUniform3i64vARB PFNGLPROGRAMUNIFORM3I64VARBPROC "typedef void (APIENTRYP PFNGLPROGRAMUNIFORM3I64VARBPROC) (GLuint program, GLint location, GLsizei count, const GLint64 *value);")
(define-entry-point glProgramUniform4i64vARB PFNGLPROGRAMUNIFORM4I64VARBPROC "typedef void (APIENTRYP PFNGLPROGRAMUNIFORM4I64VARBPROC) (GLuint program, GLint location, GLsizei count, const GLint64 *value);")
(define-entry-point glProgramUniform1ui64ARB PFNGLPROGRAMUNIFORM1UI64ARBPROC "typedef void (APIENTRYP PFNGLPROGRAMUNIFORM1UI64ARBPROC) (GLuint program, GLint location, GLuint64 x);")
(define-entry-point glProgramUniform2ui64ARB PFNGLPROGRAMUNIFORM2UI64ARBPROC "typedef void (APIENTRYP PFNGLPROGRAMUNIFORM2UI64ARBPROC) (GLuint program, GLint location, GLuint64 x, GLuint64 y);")
(define-entry-point glProgramUniform3ui64ARB PFNGLPROGRAMUNIFORM3UI64ARBPROC "typedef void (APIENTRYP PFNGLPROGRAMUNIFORM3UI64ARBPROC) (GLuint program, GLint location, GLuint64 x, GLuint64 y, GLuint64 z);")
(define-entry-point glProgramUniform4ui64ARB PFNGLPROGRAMUNIFORM4UI64ARBPROC "typedef void (APIENTRYP PFNGLPROGRAMUNIFORM4UI64ARBPROC) (GLuint program, GLint location, GLuint64 x, GLuint64 y, GLuint64 z, GLuint64 w);")
(define-entry-point glProgramUniform1ui64vARB PFNGLPROGRAMUNIFORM1UI64VARBPROC "typedef void (APIENTRYP PFNGLPROGRAMUNIFORM1UI64VARBPROC) (GLuint program, GLint location, GLsizei count, const GLuint64 *value);")
(define-entry-point glProgramUniform2ui64vARB PFNGLPROGRAMUNIFORM2UI64VARBPROC "typedef void (APIENTRYP PFNGLPROGRAMUNIFORM2UI64VARBPROC) (GLuint program, GLint location, GLsizei count, const GLuint64 *value);")
(define-entry-point glProgramUniform3ui64vARB PFNGLPROGRAMUNIFORM3UI64VARBPROC "typedef void (APIENTRYP PFNGLPROGRAMUNIFORM3UI64VARBPROC) (GLuint program, GLint location, GLsizei count, const GLuint64 *value);")
(define-entry-point glProgramUniform4ui64vARB PFNGLPROGRAMUNIFORM4UI64VARBPROC "typedef void (APIENTRYP PFNGLPROGRAMUNIFORM4UI64VARBPROC) (GLuint program, GLint location, GLsizei count, const GLuint64 *value);")
...
(define-entry-point glMultiDrawArraysIndirectCountARB PFNGLMULTIDRAWARRAYSINDIRECTCOUNTARBPROC "typedef void (APIENTRYP PFNGLMULTIDRAWARRAYSINDIRECTCOUNTARBPROC) (GLenum mode, const void *indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride);")
(define-entry-point glMultiDrawElementsIndirectCountARB PFNGLMULTIDRAWELEMENTSINDIRECTCOUNTARBPROC "typedef void (APIENTRYP PFNGLMULTIDRAWELEMENTSINDIRECTCOUNTARBPROC) (GLenum mode, GLenum type, const void *indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride);")
...
(define-entry-point glMaxShaderCompilerThreadsARB PFNGLMAXSHADERCOMPILERTHREADSARBPROC "typedef void (APIENTRYP PFNGLMAXSHADERCOMPILERTHREADSARBPROC) (GLuint count);")
...
(define-entry-point glFramebufferSampleLocationsfvARB PFNGLFRAMEBUFFERSAMPLELOCATIONSFVARBPROC "typedef void (APIENTRYP PFNGLFRAMEBUFFERSAMPLELOCATIONSFVARBPROC) (GLenum target, GLuint start, GLsizei count, const GLfloat *v);")
(define-entry-point glNamedFramebufferSampleLocationsfvARB PFNGLNAMEDFRAMEBUFFERSAMPLELOCATIONSFVARBPROC "typedef void (APIENTRYP PFNGLNAMEDFRAMEBUFFERSAMPLELOCATIONSFVARBPROC) (GLuint framebuffer, GLuint start, GLsizei count, const GLfloat *v);")
(define-entry-point glEvaluateDepthValuesARB PFNGLEVALUATEDEPTHVALUESARBPROC "typedef void (APIENTRYP PFNGLEVALUATEDEPTHVALUESARBPROC) (void);")
...
(define-entry-point glTexPageCommitmentARB PFNGLTEXPAGECOMMITMENTARBPROC "typedef void (APIENTRYP PFNGLTEXPAGECOMMITMENTARBPROC) (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLboolean commit);")
...
(define-entry-point glDepthRangeArraydvNV PFNGLDEPTHRANGEARRAYDVNVPROC "typedef void (APIENTRYP PFNGLDEPTHRANGEARRAYDVNVPROC) (GLuint first, GLsizei count, const GLdouble *v);")
(define-entry-point glDepthRangeIndexeddNV PFNGLDEPTHRANGEINDEXEDDNVPROC "typedef void (APIENTRYP PFNGLDEPTHRANGEINDEXEDDNVPROC) (GLuint index, GLdouble n, GLdouble f);")
...
(define-entry-point glMaxShaderCompilerThreadsKHR PFNGLMAXSHADERCOMPILERTHREADSKHRPROC "typedef void (APIENTRYP PFNGLMAXSHADERCOMPILERTHREADSKHRPROC) (GLuint count);")
...
(define-entry-point glGetDebugMessageLogAMD PFNGLGETDEBUGMESSAGELOGAMDPROC "typedef GLuint (APIENTRYP PFNGLGETDEBUGMESSAGELOGAMDPROC) (GLuint count, GLsizei bufSize, GLenum *categories, GLenum *severities, GLuint *ids, GLsizei *lengths, GLchar *message);")
...
(define-entry-point glRenderbufferStorageMultisampleAdvancedAMD PFNGLRENDERBUFFERSTORAGEMULTISAMPLEADVANCEDAMDPROC "typedef void (APIENTRYP PFNGLRENDERBUFFERSTORAGEMULTISAMPLEADVANCEDAMDPROC) (GLenum target, GLsizei samples, GLsizei storageSamples, GLenum internalformat, GLsizei width, GLsizei height);")
(define-entry-point glNamedRenderbufferStorageMultisampleAdvancedAMD PFNGLNAMEDRENDERBUFFERSTORAGEMULTISAMPLEADVANCEDAMDPROC "typedef void (APIENTRYP PFNGLNAMEDRENDERBUFFERSTORAGEMULTISAMPLEADVANCEDAMDPROC) (GLuint renderbuffer, GLsizei samples, GLsizei storageSamples, GLenum internalformat, GLsizei width, GLsizei height);")
(define-entry-point glFramebufferSamplePositionsfvAMD PFNGLFRAMEBUFFERSAMPLEPOSITIONSFVAMDPROC "typedef void (APIENTRYP PFNGLFRAMEBUFFERSAMPLEPOSITIONSFVAMDPROC) (GLenum target, GLuint numsamples, GLuint pixelindex, const GLfloat *values);")
(define-entry-point glNamedFramebufferSamplePositionsfvAMD PFNGLNAMEDFRAMEBUFFERSAMPLEPOSITIONSFVAMDPROC "typedef void (APIENTRYP PFNGLNAMEDFRAMEBUFFERSAMPLEPOSITIONSFVAMDPROC) (GLuint framebuffer, GLuint numsamples, GLuint pixelindex, const GLfloat *values);")
(define-entry-point glGetFramebufferParameterfvAMD PFNGLGETFRAMEBUFFERPARAMETERFVAMDPROC "typedef void (APIENTRYP PFNGLGETFRAMEBUFFERPARAMETERFVAMDPROC) (GLenum target, GLenum pname, GLuint numsamples, GLuint pixelindex, GLsizei size, GLfloat *values);")
(define-entry-point glGetNamedFramebufferParameterfvAMD PFNGLGETNAMEDFRAMEBUFFERPARAMETERFVAMDPROC "typedef void (APIENTRYP PFNGLGETNAMEDFRAMEBUFFERPARAMETERFVAMDPROC) (GLuint framebuffer, GLenum pname, GLuint numsamples, GLuint pixelindex, GLsizei size, GLfloat *values);")
...
(define-entry-point glEGLImageTargetTexStorageEXT PFNGLEGLIMAGETARGETTEXSTORAGEEXTPROC "typedef void (APIENTRYP PFNGLEGLIMAGETARGETTEXSTORAGEEXTPROC) (GLenum target, GLeglImageOES image, const GLint* attrib_list);")
(define-entry-point glEGLImageTargetTextureStorageEXT PFNGLEGLIMAGETARGETTEXTURESTORAGEEXTPROC "typedef void (APIENTRYP PFNGLEGLIMAGETARGETTEXTURESTORAGEEXTPROC) (GLuint texture, GLeglImageOES image, const GLint* attrib_list);")
...
(define-entry-point glTexturePageCommitmentEXT PFNGLTEXTUREPAGECOMMITMENTEXTPROC "typedef void (APIENTRYP PFNGLTEXTUREPAGECOMMITMENTEXTPROC) (GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLboolean commit);")
...
(define-entry-point glBufferStorageExternalEXT PFNGLBUFFERSTORAGEEXTERNALEXTPROC "typedef void (APIENTRYP PFNGLBUFFERSTORAGEEXTERNALEXTPROC) (GLenum target, GLintptr offset, GLsizeiptr size, GLeglClientBufferEXT clientBuffer, GLbitfield flags);")
(define-entry-point glNamedBufferStorageExternalEXT PFNGLNAMEDBUFFERSTORAGEEXTERNALEXTPROC "typedef void (APIENTRYP PFNGLNAMEDBUFFERSTORAGEEXTERNALEXTPROC) (GLuint buffer, GLintptr offset, GLsizeiptr size, GLeglClientBufferEXT clientBuffer, GLbitfield flags);")
...
(define-entry-point glBlitFramebufferLayersEXT PFNGLBLITFRAMEBUFFERLAYERSEXTPROC "typedef void (APIENTRYP PFNGLBLITFRAMEBUFFERLAYERSEXTPROC) (GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);")
(define-entry-point glBlitFramebufferLayerEXT PFNGLBLITFRAMEBUFFERLAYEREXTPROC "typedef void (APIENTRYP PFNGLBLITFRAMEBUFFERLAYEREXTPROC) (GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint srcLayer, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLint dstLayer, GLbitfield mask, GLenum filter);")
...
(define-entry-point glGetUnsignedBytevEXT PFNGLGETUNSIGNEDBYTEVEXTPROC "typedef void (APIENTRYP PFNGLGETUNSIGNEDBYTEVEXTPROC) (GLenum pname, GLubyte *data);")
(define-entry-point glGetUnsignedBytei_vEXT PFNGLGETUNSIGNEDBYTEI_VEXTPROC "typedef void (APIENTRYP PFNGLGETUNSIGNEDBYTEI_VEXTPROC) (GLenum target, GLuint index, GLubyte *data);")
(define-entry-point glDeleteMemoryObjectsEXT PFNGLDELETEMEMORYOBJECTSEXTPROC "typedef void (APIENTRYP PFNGLDELETEMEMORYOBJECTSEXTPROC) (GLsizei n, const GLuint *memoryObjects);")
(define-entry-point glIsMemoryObjectEXT PFNGLISMEMORYOBJECTEXTPROC "typedef GLboolean (APIENTRYP PFNGLISMEMORYOBJECTEXTPROC) (GLuint memoryObject);")
(define-entry-point glCreateMemoryObjectsEXT PFNGLCREATEMEMORYOBJECTSEXTPROC "typedef void (APIENTRYP PFNGLCREATEMEMORYOBJECTSEXTPROC) (GLsizei n, GLuint *memoryObjects);")
(define-entry-point glMemoryObjectParameterivEXT PFNGLMEMORYOBJECTPARAMETERIVEXTPROC "typedef void (APIENTRYP PFNGLMEMORYOBJECTPARAMETERIVEXTPROC) (GLuint memoryObject, GLenum pname, const GLint *params);")
(define-entry-point glGetMemoryObjectParameterivEXT PFNGLGETMEMORYOBJECTPARAMETERIVEXTPROC "typedef void (APIENTRYP PFNGLGETMEMORYOBJECTPARAMETERIVEXTPROC) (GLuint memoryObject, GLenum pname, GLint *params);")
(define-entry-point glTexStorageMem2DEXT PFNGLTEXSTORAGEMEM2DEXTPROC "typedef void (APIENTRYP PFNGLTEXSTORAGEMEM2DEXTPROC) (GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height, GLuint memory, GLuint64 offset);")
(define-entry-point glTexStorageMem2DMultisampleEXT PFNGLTEXSTORAGEMEM2DMULTISAMPLEEXTPROC "typedef void (APIENTRYP PFNGLTEXSTORAGEMEM2DMULTISAMPLEEXTPROC) (GLenum target, GLsizei samples, GLenum internalFormat, GLsizei width, GLsizei height, GLboolean fixedSampleLocations, GLuint memory, GLuint64 offset);")
(define-entry-point glTexStorageMem3DEXT PFNGLTEXSTORAGEMEM3DEXTPROC "typedef void (APIENTRYP PFNGLTEXSTORAGEMEM3DEXTPROC) (GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLuint memory, GLuint64 offset);")
(define-entry-point glTexStorageMem3DMultisampleEXT PFNGLTEXSTORAGEMEM3DMULTISAMPLEEXTPROC "typedef void (APIENTRYP PFNGLTEXSTORAGEMEM3DMULTISAMPLEEXTPROC) (GLenum target, GLsizei samples, GLenum internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedSampleLocations, GLuint memory, GLuint64 offset);")
(define-entry-point glBufferStorageMemEXT PFNGLBUFFERSTORAGEMEMEXTPROC "typedef void (APIENTRYP PFNGLBUFFERSTORAGEMEMEXTPROC) (GLenum target, GLsizeiptr size, GLuint memory, GLuint64 offset);")
(define-entry-point glTextureStorageMem2DEXT PFNGLTEXTURESTORAGEMEM2DEXTPROC "typedef void (APIENTRYP PFNGLTEXTURESTORAGEMEM2DEXTPROC) (GLuint texture, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height, GLuint memory, GLuint64 offset);")
(define-entry-point glTextureStorageMem2DMultisampleEXT PFNGLTEXTURESTORAGEMEM2DMULTISAMPLEEXTPROC "typedef void (APIENTRYP PFNGLTEXTURESTORAGEMEM2DMULTISAMPLEEXTPROC) (GLuint texture, GLsizei samples, GLenum internalFormat, GLsizei width, GLsizei height, GLboolean fixedSampleLocations, GLuint memory, GLuint64 offset);")
(define-entry-point glTextureStorageMem3DEXT PFNGLTEXTURESTORAGEMEM3DEXTPROC "typedef void (APIENTRYP PFNGLTEXTURESTORAGEMEM3DEXTPROC) (GLuint texture, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLuint memory, GLuint64 offset);")
(define-entry-point glTextureStorageMem3DMultisampleEXT PFNGLTEXTURESTORAGEMEM3DMULTISAMPLEEXTPROC "typedef void (APIENTRYP PFNGLTEXTURESTORAGEMEM3DMULTISAMPLEEXTPROC) (GLuint texture, GLsizei samples, GLenum internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedSampleLocations, GLuint memory, GLuint64 offset);")
(define-entry-point glNamedBufferStorageMemEXT PFNGLNAMEDBUFFERSTORAGEMEMEXTPROC "typedef void (APIENTRYP PFNGLNAMEDBUFFERSTORAGEMEMEXTPROC) (GLuint buffer, GLsizeiptr size, GLuint memory, GLuint64 offset);")
(define-entry-point glTexStorageMem1DEXT PFNGLTEXSTORAGEMEM1DEXTPROC "typedef void (APIENTRYP PFNGLTEXSTORAGEMEM1DEXTPROC) (GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLuint memory, GLuint64 offset);")
(define-entry-point glTextureStorageMem1DEXT PFNGLTEXTURESTORAGEMEM1DEXTPROC "typedef void (APIENTRYP PFNGLTEXTURESTORAGEMEM1DEXTPROC) (GLuint texture, GLsizei levels, GLenum internalFormat, GLsizei width, GLuint memory, GLuint64 offset);")
(define-entry-point glImportMemoryFdEXT PFNGLIMPORTMEMORYFDEXTPROC "typedef void (APIENTRYP PFNGLIMPORTMEMORYFDEXTPROC) (GLuint memory, GLuint64 size, GLenum handleType, GLint fd);")
(define-entry-point glImportMemoryWin32HandleEXT PFNGLIMPORTMEMORYWIN32HANDLEEXTPROC "typedef void (APIENTRYP PFNGLIMPORTMEMORYWIN32HANDLEEXTPROC) (GLuint memory, GLuint64 size, GLenum handleType, void *handle);")
(define-entry-point glImportMemoryWin32NameEXT PFNGLIMPORTMEMORYWIN32NAMEEXTPROC "typedef void (APIENTRYP PFNGLIMPORTMEMORYWIN32NAMEEXTPROC) (GLuint memory, GLuint64 size, GLenum handleType, const void *name);")
...
(define-entry-point glGenSemaphoresEXT PFNGLGENSEMAPHORESEXTPROC "typedef void (APIENTRYP PFNGLGENSEMAPHORESEXTPROC) (GLsizei n, GLuint *semaphores);")
(define-entry-point glDeleteSemaphoresEXT PFNGLDELETESEMAPHORESEXTPROC "typedef void (APIENTRYP PFNGLDELETESEMAPHORESEXTPROC) (GLsizei n, const GLuint *semaphores);")
(define-entry-point glIsSemaphoreEXT PFNGLISSEMAPHOREEXTPROC "typedef GLboolean (APIENTRYP PFNGLISSEMAPHOREEXTPROC) (GLuint semaphore);")
(define-entry-point glSemaphoreParameterui64vEXT PFNGLSEMAPHOREPARAMETERUI64VEXTPROC "typedef void (APIENTRYP PFNGLSEMAPHOREPARAMETERUI64VEXTPROC) (GLuint semaphore, GLenum pname, const GLuint64 *params);")
(define-entry-point glGetSemaphoreParameterui64vEXT PFNGLGETSEMAPHOREPARAMETERUI64VEXTPROC "typedef void (APIENTRYP PFNGLGETSEMAPHOREPARAMETERUI64VEXTPROC) (GLuint semaphore, GLenum pname, GLuint64 *params);")
(define-entry-point glWaitSemaphoreEXT PFNGLWAITSEMAPHOREEXTPROC "typedef void (APIENTRYP PFNGLWAITSEMAPHOREEXTPROC) (GLuint semaphore, GLuint numBufferBarriers, const GLuint *buffers, GLuint numTextureBarriers, const GLuint *textures, const GLenum *srcLayouts);")
(define-entry-point glSignalSemaphoreEXT PFNGLSIGNALSEMAPHOREEXTPROC "typedef void (APIENTRYP PFNGLSIGNALSEMAPHOREEXTPROC) (GLuint semaphore, GLuint numBufferBarriers, const GLuint *buffers, GLuint numTextureBarriers, const GLuint *textures, const GLenum *dstLayouts);")
(define-entry-point glImportSemaphoreFdEXT PFNGLIMPORTSEMAPHOREFDEXTPROC "typedef void (APIENTRYP PFNGLIMPORTSEMAPHOREFDEXTPROC) (GLuint semaphore, GLenum handleType, GLint fd);")
(define-entry-point glImportSemaphoreWin32HandleEXT PFNGLIMPORTSEMAPHOREWIN32HANDLEEXTPROC "typedef void (APIENTRYP PFNGLIMPORTSEMAPHOREWIN32HANDLEEXTPROC) (GLuint semaphore, GLenum handleType, void *handle);")
(define-entry-point glImportSemaphoreWin32NameEXT PFNGLIMPORTSEMAPHOREWIN32NAMEEXTPROC "typedef void (APIENTRYP PFNGLIMPORTSEMAPHOREWIN32NAMEEXTPROC) (GLuint semaphore, GLenum handleType, const void *name);")
...
(define-entry-point glFramebufferFetchBarrierEXT PFNGLFRAMEBUFFERFETCHBARRIEREXTPROC "typedef void (APIENTRYP PFNGLFRAMEBUFFERFETCHBARRIEREXTPROC) (void);")
...
(define-entry-point glTexStorage1DEXT PFNGLTEXSTORAGE1DEXTPROC "typedef void (APIENTRYP PFNGLTEXSTORAGE1DEXTPROC) (GLenum target, GLsizei levels, GLenum internalformat, GLsizei width);")
(define-entry-point glTexStorage2DEXT PFNGLTEXSTORAGE2DEXTPROC "typedef void (APIENTRYP PFNGLTEXSTORAGE2DEXTPROC) (GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height);")
(define-entry-point glTexStorage3DEXT PFNGLTEXSTORAGE3DEXTPROC "typedef void (APIENTRYP PFNGLTEXSTORAGE3DEXTPROC) (GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth);")
...
(define-entry-point glAcquireKeyedMutexWin32EXT PFNGLACQUIREKEYEDMUTEXWIN32EXTPROC "typedef GLboolean (APIENTRYP PFNGLACQUIREKEYEDMUTEXWIN32EXTPROC) (GLuint memory, GLuint64 key, GLuint timeout);")
(define-entry-point glReleaseKeyedMutexWin32EXT PFNGLRELEASEKEYEDMUTEXWIN32EXTPROC "typedef GLboolean (APIENTRYP PFNGLRELEASEKEYEDMUTEXWIN32EXTPROC) (GLuint memory, GLuint64 key);")
(define-entry-point glWindowRectanglesEXT PFNGLWINDOWRECTANGLESEXTPROC "typedef void (APIENTRYP PFNGLWINDOWRECTANGLESEXTPROC) (GLenum mode, GLsizei count, const GLint *box);")
...
(define-entry-point glApplyFramebufferAttachmentCMAAINTEL PFNGLAPPLYFRAMEBUFFERATTACHMENTCMAAINTELPROC "typedef void (APIENTRYP PFNGLAPPLYFRAMEBUFFERATTACHMENTCMAAINTELPROC) (void);")
...
(define-entry-point glGetPerfQueryDataINTEL PFNGLGETPERFQUERYDATAINTELPROC "typedef void (APIENTRYP PFNGLGETPERFQUERYDATAINTELPROC) (GLuint queryHandle, GLuint flags, GLsizei dataSize, void *data, GLuint *bytesWritten);")
...
(define-entry-point glFramebufferParameteriMESA PFNGLFRAMEBUFFERPARAMETERIMESAPROC "typedef void (APIENTRYP PFNGLFRAMEBUFFERPARAMETERIMESAPROC) (GLenum target, GLenum pname, GLint param);")
(define-entry-point glGetFramebufferParameterivMESA PFNGLGETFRAMEBUFFERPARAMETERIVMESAPROC "typedef void (APIENTRYP PFNGLGETFRAMEBUFFERPARAMETERIVMESAPROC) (GLenum target, GLenum pname, GLint *params);")
...
(define-entry-point glUploadGpuMaskNVX PFNGLUPLOADGPUMASKNVXPROC "typedef void (APIENTRYP PFNGLUPLOADGPUMASKNVXPROC) (GLbitfield mask);")
(define-entry-point glMulticastViewportArrayvNVX PFNGLMULTICASTVIEWPORTARRAYVNVXPROC "typedef void (APIENTRYP PFNGLMULTICASTVIEWPORTARRAYVNVXPROC) (GLuint gpu, GLuint first, GLsizei count, const GLfloat *v);")
(define-entry-point glMulticastViewportPositionWScaleNVX PFNGLMULTICASTVIEWPORTPOSITIONWSCALENVXPROC "typedef void (APIENTRYP PFNGLMULTICASTVIEWPORTPOSITIONWSCALENVXPROC) (GLuint gpu, GLuint index, GLfloat xcoeff, GLfloat ycoeff);")
(define-entry-point glMulticastScissorArrayvNVX PFNGLMULTICASTSCISSORARRAYVNVXPROC "typedef void (APIENTRYP PFNGLMULTICASTSCISSORARRAYVNVXPROC) (GLuint gpu, GLuint first, GLsizei count, const GLint *v);")
(define-entry-point glAsyncCopyBufferSubDataNVX PFNGLASYNCCOPYBUFFERSUBDATANVXPROC "typedef GLuint (APIENTRYP PFNGLASYNCCOPYBUFFERSUBDATANVXPROC) (GLsizei waitSemaphoreCount, const GLuint *waitSemaphoreArray, const GLuint64 *fenceValueArray, GLuint readGpu, GLbitfield writeGpuMask, GLuint readBuffer, GLuint writeBuffer, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size, GLsizei signalSemaphoreCount, const GLuint *signalSemaphoreArray, const GLuint64 *signalValueArray);")
(define-entry-point glAsyncCopyImageSubDataNVX PFNGLASYNCCOPYIMAGESUBDATANVXPROC "typedef GLuint (APIENTRYP PFNGLASYNCCOPYIMAGESUBDATANVXPROC) (GLsizei waitSemaphoreCount, const GLuint *waitSemaphoreArray, const GLuint64 *waitValueArray, GLuint srcGpu, GLbitfield dstGpuMask, GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srcY, GLint srcZ, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei srcWidth, GLsizei srcHeight, GLsizei srcDepth, GLsizei signalSemaphoreCount, const GLuint *signalSemaphoreArray, const GLuint64 *signalValueArray);")
(define-entry-point glLGPUNamedBufferSubDataNVX PFNGLLGPUNAMEDBUFFERSUBDATANVXPROC "typedef void (APIENTRYP PFNGLLGPUNAMEDBUFFERSUBDATANVXPROC) (GLbitfield gpuMask, GLuint buffer, GLintptr offset, GLsizeiptr size, const void *data);")
(define-entry-point glLGPUCopyImageSubDataNVX PFNGLLGPUCOPYIMAGESUBDATANVXPROC "typedef void (APIENTRYP PFNGLLGPUCOPYIMAGESUBDATANVXPROC) (GLuint sourceGpu, GLbitfield destinationGpuMask, GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srxY, GLint srcZ, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei width, GLsizei height, GLsizei depth);")
(define-entry-point glLGPUInterlockNVX PFNGLLGPUINTERLOCKNVXPROC "typedef void (APIENTRYP PFNGLLGPUINTERLOCKNVXPROC) (void);")
(define-entry-point glCreateProgressFenceNVX PFNGLCREATEPROGRESSFENCENVXPROC "typedef GLuint (APIENTRYP PFNGLCREATEPROGRESSFENCENVXPROC) (void);")
(define-entry-point glSignalSemaphoreui64NVX PFNGLSIGNALSEMAPHOREUI64NVXPROC "typedef void (APIENTRYP PFNGLSIGNALSEMAPHOREUI64NVXPROC) (GLuint signalGpu, GLsizei fenceObjectCount, const GLuint *semaphoreArray, const GLuint64 *fenceValueArray);")
(define-entry-point glWaitSemaphoreui64NVX PFNGLWAITSEMAPHOREUI64NVXPROC "typedef void (APIENTRYP PFNGLWAITSEMAPHOREUI64NVXPROC) (GLuint waitGpu, GLsizei fenceObjectCount, const GLuint *semaphoreArray, const GLuint64 *fenceValueArray);")
(define-entry-point glClientWaitSemaphoreui64NVX PFNGLCLIENTWAITSEMAPHOREUI64NVXPROC "typedef void (APIENTRYP PFNGLCLIENTWAITSEMAPHOREUI64NVXPROC) (GLsizei fenceObjectCount, const GLuint *semaphoreArray, const GLuint64 *fenceValueArray);")
(define-entry-point glAlphaToCoverageDitherControlNV PFNGLALPHATOCOVERAGEDITHERCONTROLNVPROC "typedef void (APIENTRYP PFNGLALPHATOCOVERAGEDITHERCONTROLNVPROC) (GLenum mode);")
...
(define-entry-point glViewportPositionWScaleNV PFNGLVIEWPORTPOSITIONWSCALENVPROC "typedef void (APIENTRYP PFNGLVIEWPORTPOSITIONWSCALENVPROC) (GLuint index, GLfloat xcoeff, GLfloat ycoeff);")
(define-entry-point glCreateStatesNV PFNGLCREATESTATESNVPROC "typedef void (APIENTRYP PFNGLCREATESTATESNVPROC) (GLsizei n, GLuint *states);")
(define-entry-point glDeleteStatesNV PFNGLDELETESTATESNVPROC "typedef void (APIENTRYP PFNGLDELETESTATESNVPROC) (GLsizei n, const GLuint *states);")
(define-entry-point glIsStateNV PFNGLISSTATENVPROC "typedef GLboolean (APIENTRYP PFNGLISSTATENVPROC) (GLuint state);")
(define-entry-point glStateCaptureNV PFNGLSTATECAPTURENVPROC "typedef void (APIENTRYP PFNGLSTATECAPTURENVPROC) (GLuint state, GLenum mode);")
(define-entry-point glGetCommandHeaderNV PFNGLGETCOMMANDHEADERNVPROC "typedef GLuint (APIENTRYP PFNGLGETCOMMANDHEADERNVPROC) (GLenum tokenID, GLuint size);")
(define-entry-point glGetStageIndexNV PFNGLGETSTAGEINDEXNVPROC "typedef GLushort (APIENTRYP PFNGLGETSTAGEINDEXNVPROC) (GLenum shadertype);")
(define-entry-point glDrawCommandsNV PFNGLDRAWCOMMANDSNVPROC "typedef void (APIENTRYP PFNGLDRAWCOMMANDSNVPROC) (GLenum primitiveMode, GLuint buffer, const GLintptr *indirects, const GLsizei *sizes, GLuint count);")
(define-entry-point glDrawCommandsAddressNV PFNGLDRAWCOMMANDSADDRESSNVPROC "typedef void (APIENTRYP PFNGLDRAWCOMMANDSADDRESSNVPROC) (GLenum primitiveMode, const GLuint64 *indirects, const GLsizei *sizes, GLuint count);")
(define-entry-point glDrawCommandsStatesNV PFNGLDRAWCOMMANDSSTATESNVPROC "typedef void (APIENTRYP PFNGLDRAWCOMMANDSSTATESNVPROC) (GLuint buffer, const GLintptr *indirects, const GLsizei *sizes, const GLuint *states, const GLuint *fbos, GLuint count);")
(define-entry-point glDrawCommandsStatesAddressNV PFNGLDRAWCOMMANDSSTATESADDRESSNVPROC "typedef void (APIENTRYP PFNGLDRAWCOMMANDSSTATESADDRESSNVPROC) (const GLuint64 *indirects, const GLsizei *sizes, const GLuint *states, const GLuint *fbos, GLuint count);")
(define-entry-point glCreateCommandListsNV PFNGLCREATECOMMANDLISTSNVPROC "typedef void (APIENTRYP PFNGLCREATECOMMANDLISTSNVPROC) (GLsizei n, GLuint *lists);")
(define-entry-point glDeleteCommandListsNV PFNGLDELETECOMMANDLISTSNVPROC "typedef void (APIENTRYP PFNGLDELETECOMMANDLISTSNVPROC) (GLsizei n, const GLuint *lists);")
(define-entry-point glIsCommandListNV PFNGLISCOMMANDLISTNVPROC "typedef GLboolean (APIENTRYP PFNGLISCOMMANDLISTNVPROC) (GLuint list);")
(define-entry-point glListDrawCommandsStatesClientNV PFNGLLISTDRAWCOMMANDSSTATESCLIENTNVPROC "typedef void (APIENTRYP PFNGLLISTDRAWCOMMANDSSTATESCLIENTNVPROC) (GLuint list, GLuint segment, const void **indirects, const GLsizei *sizes, const GLuint *states, const GLuint *fbos, GLuint count);")
(define-entry-point glCommandListSegmentsNV PFNGLCOMMANDLISTSEGMENTSNVPROC "typedef void (APIENTRYP PFNGLCOMMANDLISTSEGMENTSNVPROC) (GLuint list, GLuint segments);")
(define-entry-point glCompileCommandListNV PFNGLCOMPILECOMMANDLISTNVPROC "typedef void (APIENTRYP PFNGLCOMPILECOMMANDLISTNVPROC) (GLuint list);")
(define-entry-point glCallCommandListNV PFNGLCALLCOMMANDLISTNVPROC "typedef void (APIENTRYP PFNGLCALLCOMMANDLISTNVPROC) (GLuint list);")
...
(define-entry-point glConservativeRasterParameterfNV PFNGLCONSERVATIVERASTERPARAMETERFNVPROC "typedef void (APIENTRYP PFNGLCONSERVATIVERASTERPARAMETERFNVPROC) (GLenum pname, GLfloat value);")
(define-entry-point glConservativeRasterParameteriNV PFNGLCONSERVATIVERASTERPARAMETERINVPROC "typedef void (APIENTRYP PFNGLCONSERVATIVERASTERPARAMETERINVPROC) (GLenum pname, GLint param);")
...
(define-entry-point glDrawVkImageNV PFNGLDRAWVKIMAGENVPROC "typedef void (APIENTRYP PFNGLDRAWVKIMAGENVPROC) (GLuint64 vkImage, GLuint sampler, GLfloat x0, GLfloat y0, GLfloat x1, GLfloat y1, GLfloat z, GLfloat s0, GLfloat t0, GLfloat s1, GLfloat t1);")
(define-entry-point glGetVkProcAddrNV PFNGLGETVKPROCADDRNVPROC "typedef GLVULKANPROCNV (APIENTRYP PFNGLGETVKPROCADDRNVPROC) (const GLchar *name);")
(define-entry-point glWaitVkSemaphoreNV PFNGLWAITVKSEMAPHORENVPROC "typedef void (APIENTRYP PFNGLWAITVKSEMAPHORENVPROC) (GLuint64 vkSemaphore);")
(define-entry-point glSignalVkSemaphoreNV PFNGLSIGNALVKSEMAPHORENVPROC "typedef void (APIENTRYP PFNGLSIGNALVKSEMAPHORENVPROC) (GLuint64 vkSemaphore);")
(define-entry-point glSignalVkFenceNV PFNGLSIGNALVKFENCENVPROC "typedef void (APIENTRYP PFNGLSIGNALVKFENCENVPROC) (GLuint64 vkFence);")
...
(define-entry-point glRenderGpuMaskNV PFNGLRENDERGPUMASKNVPROC "typedef void (APIENTRYP PFNGLRENDERGPUMASKNVPROC) (GLbitfield mask);")
(define-entry-point glMulticastBufferSubDataNV PFNGLMULTICASTBUFFERSUBDATANVPROC "typedef void (APIENTRYP PFNGLMULTICASTBUFFERSUBDATANVPROC) (GLbitfield gpuMask, GLuint buffer, GLintptr offset, GLsizeiptr size, const void *data);")
(define-entry-point glMulticastCopyBufferSubDataNV PFNGLMULTICASTCOPYBUFFERSUBDATANVPROC "typedef void (APIENTRYP PFNGLMULTICASTCOPYBUFFERSUBDATANVPROC) (GLuint readGpu, GLbitfield writeGpuMask, GLuint readBuffer, GLuint writeBuffer, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size);")
(define-entry-point glMulticastCopyImageSubDataNV PFNGLMULTICASTCOPYIMAGESUBDATANVPROC "typedef void (APIENTRYP PFNGLMULTICASTCOPYIMAGESUBDATANVPROC) (GLuint srcGpu, GLbitfield dstGpuMask, GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srcY, GLint srcZ, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei srcWidth, GLsizei srcHeight, GLsizei srcDepth);")
(define-entry-point glMulticastBlitFramebufferNV PFNGLMULTICASTBLITFRAMEBUFFERNVPROC "typedef void (APIENTRYP PFNGLMULTICASTBLITFRAMEBUFFERNVPROC) (GLuint srcGpu, GLuint dstGpu, GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);")
(define-entry-point glMulticastFramebufferSampleLocationsfvNV PFNGLMULTICASTFRAMEBUFFERSAMPLELOCATIONSFVNVPROC "typedef void (APIENTRYP PFNGLMULTICASTFRAMEBUFFERSAMPLELOCATIONSFVNVPROC) (GLuint gpu, GLuint framebuffer, GLuint start, GLsizei count, const GLfloat *v);")
(define-entry-point glMulticastBarrierNV PFNGLMULTICASTBARRIERNVPROC "typedef void (APIENTRYP PFNGLMULTICASTBARRIERNVPROC) (void);")
(define-entry-point glMulticastWaitSyncNV PFNGLMULTICASTWAITSYNCNVPROC "typedef void (APIENTRYP PFNGLMULTICASTWAITSYNCNVPROC) (GLuint signalGpu, GLbitfield waitGpuMask);")
(define-entry-point glMulticastGetQueryObjectivNV PFNGLMULTICASTGETQUERYOBJECTIVNVPROC "typedef void (APIENTRYP PFNGLMULTICASTGETQUERYOBJECTIVNVPROC) (GLuint gpu, GLuint id, GLenum pname, GLint *params);")
(define-entry-point glMulticastGetQueryObjectuivNV PFNGLMULTICASTGETQUERYOBJECTUIVNVPROC "typedef void (APIENTRYP PFNGLMULTICASTGETQUERYOBJECTUIVNVPROC) (GLuint gpu, GLuint id, GLenum pname, GLuint *params);")
(define-entry-point glMulticastGetQueryObjecti64vNV PFNGLMULTICASTGETQUERYOBJECTI64VNVPROC "typedef void (APIENTRYP PFNGLMULTICASTGETQUERYOBJECTI64VNVPROC) (GLuint gpu, GLuint id, GLenum pname, GLint64 *params);")
(define-entry-point glMulticastGetQueryObjectui64vNV PFNGLMULTICASTGETQUERYOBJECTUI64VNVPROC "typedef void (APIENTRYP PFNGLMULTICASTGETQUERYOBJECTUI64VNVPROC) (GLuint gpu, GLuint id, GLenum pname, GLuint64 *params);")
...
(define-entry-point glGetInternalformatSampleivNV PFNGLGETINTERNALFORMATSAMPLEIVNVPROC "typedef void (APIENTRYP PFNGLGETINTERNALFORMATSAMPLEIVNVPROC) (GLenum target, GLenum internalformat, GLsizei samples, GLenum pname, GLsizei count, GLint *params);")
(define-entry-point glGetMemoryObjectDetachedResourcesuivNV PFNGLGETMEMORYOBJECTDETACHEDRESOURCESUIVNVPROC "typedef void (APIENTRYP PFNGLGETMEMORYOBJECTDETACHEDRESOURCESUIVNVPROC) (GLuint memory, GLenum pname, GLint first, GLsizei count, GLuint *params);")
(define-entry-point glResetMemoryObjectParameterNV PFNGLRESETMEMORYOBJECTPARAMETERNVPROC "typedef void (APIENTRYP PFNGLRESETMEMORYOBJECTPARAMETERNVPROC) (GLuint memory, GLenum pname);")
(define-entry-point glTexAttachMemoryNV PFNGLTEXATTACHMEMORYNVPROC "typedef void (APIENTRYP PFNGLTEXATTACHMEMORYNVPROC) (GLenum target, GLuint memory, GLuint64 offset);")
(define-entry-point glBufferAttachMemoryNV PFNGLBUFFERATTACHMEMORYNVPROC "typedef void (APIENTRYP PFNGLBUFFERATTACHMEMORYNVPROC) (GLenum target, GLuint memory, GLuint64 offset);")
(define-entry-point glTextureAttachMemoryNV PFNGLTEXTUREATTACHMEMORYNVPROC "typedef void (APIENTRYP PFNGLTEXTUREATTACHMEMORYNVPROC) (GLuint texture, GLuint memory, GLuint64 offset);")
(define-entry-point glNamedBufferAttachMemoryNV PFNGLNAMEDBUFFERATTACHMEMORYNVPROC "typedef void (APIENTRYP PFNGLNAMEDBUFFERATTACHMEMORYNVPROC) (GLuint buffer, GLuint memory, GLuint64 offset);")
(define-entry-point glBufferPageCommitmentMemNV PFNGLBUFFERPAGECOMMITMENTMEMNVPROC "typedef void (APIENTRYP PFNGLBUFFERPAGECOMMITMENTMEMNVPROC) (GLenum target, GLintptr offset, GLsizeiptr size, GLuint memory, GLuint64 memOffset, GLboolean commit);")
(define-entry-point glTexPageCommitmentMemNV PFNGLTEXPAGECOMMITMENTMEMNVPROC "typedef void (APIENTRYP PFNGLTEXPAGECOMMITMENTMEMNVPROC) (GLenum target, GLint layer, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLuint memory, GLuint64 offset, GLboolean commit);")
(define-entry-point glNamedBufferPageCommitmentMemNV PFNGLNAMEDBUFFERPAGECOMMITMENTMEMNVPROC "typedef void (APIENTRYP PFNGLNAMEDBUFFERPAGECOMMITMENTMEMNVPROC) (GLuint buffer, GLintptr offset, GLsizeiptr size, GLuint memory, GLuint64 memOffset, GLboolean commit);")
(define-entry-point glTexturePageCommitmentMemNV PFNGLTEXTUREPAGECOMMITMENTMEMNVPROC "typedef void (APIENTRYP PFNGLTEXTUREPAGECOMMITMENTMEMNVPROC) (GLuint texture, GLint layer, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLuint memory, GLuint64 offset, GLboolean commit);")
(define-entry-point glDrawMeshTasksNV PFNGLDRAWMESHTASKSNVPROC "typedef void (APIENTRYP PFNGLDRAWMESHTASKSNVPROC) (GLuint first, GLuint count);")
(define-entry-point glDrawMeshTasksIndirectNV PFNGLDRAWMESHTASKSINDIRECTNVPROC "typedef void (APIENTRYP PFNGLDRAWMESHTASKSINDIRECTNVPROC) (GLintptr indirect);")
(define-entry-point glMultiDrawMeshTasksIndirectNV PFNGLMULTIDRAWMESHTASKSINDIRECTNVPROC "typedef void (APIENTRYP PFNGLMULTIDRAWMESHTASKSINDIRECTNVPROC) (GLintptr indirect, GLsizei drawcount, GLsizei stride);")
(define-entry-point glMultiDrawMeshTasksIndirectCountNV PFNGLMULTIDRAWMESHTASKSINDIRECTCOUNTNVPROC "typedef void (APIENTRYP PFNGLMULTIDRAWMESHTASKSINDIRECTCOUNTNVPROC) (GLintptr indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride);")
...
(define-entry-point glPathGlyphIndexRangeNV PFNGLPATHGLYPHINDEXRANGENVPROC "typedef GLenum (APIENTRYP PFNGLPATHGLYPHINDEXRANGENVPROC) (GLenum fontTarget, const void *fontName, GLbitfield fontStyle, GLuint pathParameterTemplate, GLfloat emScale, GLuint *baseAndCount);")
...
(define-entry-point glGetProgramResourcefvNV PFNGLGETPROGRAMRESOURCEFVNVPROC "typedef void (APIENTRYP PFNGLGETPROGRAMRESOURCEFVNVPROC) (GLuint program, GLenum programInterface, GLuint index, GLsizei propCount, const GLenum *props, GLsizei count, GLsizei *length, GLfloat *params);")
...
(define-entry-point glQueryResourceNV PFNGLQUERYRESOURCENVPROC "typedef GLint (APIENTRYP PFNGLQUERYRESOURCENVPROC) (GLenum queryType, GLint tagId, GLuint count, GLint *buffer);")
(define-entry-point glGenQueryResourceTagNV PFNGLGENQUERYRESOURCETAGNVPROC "typedef void (APIENTRYP PFNGLGENQUERYRESOURCETAGNVPROC) (GLsizei n, GLint *tagIds);")
(define-entry-point glDeleteQueryResourceTagNV PFNGLDELETEQUERYRESOURCETAGNVPROC "typedef void (APIENTRYP PFNGLDELETEQUERYRESOURCETAGNVPROC) (GLsizei n, const GLint *tagIds);")
(define-entry-point glQueryResourceTagNV PFNGLQUERYRESOURCETAGNVPROC "typedef void (APIENTRYP PFNGLQUERYRESOURCETAGNVPROC) (GLint tagId, const GLchar *tagString);")
...
(define-entry-point glScissorExclusiveNV PFNGLSCISSOREXCLUSIVENVPROC "typedef void (APIENTRYP PFNGLSCISSOREXCLUSIVENVPROC) (GLint x, GLint y, GLsizei width, GLsizei height);")
(define-entry-point glScissorExclusiveArrayvNV PFNGLSCISSOREXCLUSIVEARRAYVNVPROC "typedef void (APIENTRYP PFNGLSCISSOREXCLUSIVEARRAYVNVPROC) (GLuint first, GLsizei count, const GLint *v);")
...
(define-entry-point glBindShadingRateImageNV PFNGLBINDSHADINGRATEIMAGENVPROC "typedef void (APIENTRYP PFNGLBINDSHADINGRATEIMAGENVPROC) (GLuint texture);")
(define-entry-point glGetShadingRateImagePaletteNV PFNGLGETSHADINGRATEIMAGEPALETTENVPROC "typedef void (APIENTRYP PFNGLGETSHADINGRATEIMAGEPALETTENVPROC) (GLuint viewport, GLuint entry, GLenum *rate);")
(define-entry-point glGetShadingRateSampleLocationivNV PFNGLGETSHADINGRATESAMPLELOCATIONIVNVPROC "typedef void (APIENTRYP PFNGLGETSHADINGRATESAMPLELOCATIONIVNVPROC) (GLenum rate, GLuint samples, GLuint index, GLint *location);")
(define-entry-point glShadingRateImageBarrierNV PFNGLSHADINGRATEIMAGEBARRIERNVPROC "typedef void (APIENTRYP PFNGLSHADINGRATEIMAGEBARRIERNVPROC) (GLboolean synchronize);")
(define-entry-point glShadingRateImagePaletteNV PFNGLSHADINGRATEIMAGEPALETTENVPROC "typedef void (APIENTRYP PFNGLSHADINGRATEIMAGEPALETTENVPROC) (GLuint viewport, GLuint first, GLsizei count, const GLenum *rates);")
(define-entry-point glShadingRateSampleOrderNV PFNGLSHADINGRATESAMPLEORDERNVPROC "typedef void (APIENTRYP PFNGLSHADINGRATESAMPLEORDERNVPROC) (GLenum order);")
(define-entry-point glShadingRateSampleOrderCustomNV PFNGLSHADINGRATESAMPLEORDERCUSTOMNVPROC "typedef void (APIENTRYP PFNGLSHADINGRATESAMPLEORDERCUSTOMNVPROC) (GLenum rate, GLuint samples, const GLint *locations);")
...
(define-entry-point glCreateSemaphoresNV PFNGLCREATESEMAPHORESNVPROC "typedef void (APIENTRYP PFNGLCREATESEMAPHORESNVPROC) (GLsizei n, GLuint *semaphores);")
(define-entry-point glSemaphoreParameterivNV PFNGLSEMAPHOREPARAMETERIVNVPROC "typedef void (APIENTRYP PFNGLSEMAPHOREPARAMETERIVNVPROC) (GLuint semaphore, GLenum pname, const GLint *params);")
(define-entry-point glGetSemaphoreParameterivNV PFNGLGETSEMAPHOREPARAMETERIVNVPROC "typedef void (APIENTRYP PFNGLGETSEMAPHOREPARAMETERIVNVPROC) (GLuint semaphore, GLenum pname, GLint *params);")
...
(define-entry-point glVDPAUGetSurfaceivNV PFNGLVDPAUGETSURFACEIVNVPROC "typedef void (APIENTRYP PFNGLVDPAUGETSURFACEIVNVPROC) (GLvdpauSurfaceNV surface, GLenum pname, GLsizei count, GLsizei *length, GLint *values);")
...
(define-entry-point glVDPAURegisterVideoSurfaceWithPictureStructureNV PFNGLVDPAUREGISTERVIDEOSURFACEWITHPICTURESTRUCTURENVPROC "typedef GLvdpauSurfaceNV (APIENTRYP PFNGLVDPAUREGISTERVIDEOSURFACEWITHPICTURESTRUCTURENVPROC) (const void *vdpSurface, GLenum target, GLsizei numTextureNames, const GLuint *textureNames, GLboolean isFrameStructure);")
...
(define-entry-point glViewportSwizzleNV PFNGLVIEWPORTSWIZZLENVPROC "typedef void (APIENTRYP PFNGLVIEWPORTSWIZZLENVPROC) (GLuint index, GLenum swizzlex, GLenum swizzley, GLenum swizzlez, GLenum swizzlew);")
(define-entry-point glFramebufferTextureMultiviewOVR PFNGLFRAMEBUFFERTEXTUREMULTIVIEWOVRPROC "typedef void (APIENTRYP PFNGLFRAMEBUFFERTEXTUREMULTIVIEWOVRPROC) (GLenum target, GLenum attachment, GLuint texture, GLint level, GLint baseViewIndex, GLsizei numViews);")
