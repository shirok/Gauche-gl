...
(define-extension-name GL_VERSION_1_2_DEPRECATED)
(define-extension-name GL_ARB_imaging)
(define-extension-name GL_ARB_imaging_DEPRECATED)
(define-extension-name GL_VERSION_1_3)
(define-extension-name GL_VERSION_1_3_DEPRECATED)
(define-extension-name GL_VERSION_1_4)
(define-extension-name GL_VERSION_1_4_DEPRECATED)
(define-extension-name GL_VERSION_1_5)
(define-extension-name GL_VERSION_1_5_DEPRECATED)
(define-extension-name GL_VERSION_2_0)
(define-extension-name GL_VERSION_2_0_DEPRECATED)
(define-extension-name GL_VERSION_2_1)
(define-extension-name GL_VERSION_2_1_DEPRECATED)
(define-extension-name GL_VERSION_3_0)
(define-extension-name GL_VERSION_3_0_DEPRECATED)
...
(define-extension-name GL_ARB_framebuffer_object_DEPRECATED)
...
(define-extension-name GL_AMD_vertex_shader_tesselator)
...
(define-constant GL_GLEXT_VERSION #x0048)
...
(define-constant GL_DEPTH_BUFFER #x8223)
(define-constant GL_STENCIL_BUFFER #x8224)
...
(define-constant GL_TEXTURE_BUFFER_FORMAT #x8c2e)
...
(define-constant GL_MAX_TRANSFORM_FEEDBACK_INTERLEAVED_ATTRIBS_NV #x8c8a)
...
(define-constant GL_COVERAGE_SAMPLES_NV #x80a9)
...
(define-entry-point glMultiDrawArrays PFNGLMULTIDRAWARRAYSPROC "typedef void (APIENTRYP PFNGLMULTIDRAWARRAYSPROC) (GLenum mode, const GLint *first, const GLsizei *count, GLsizei primcount);")
...
(define-entry-point glTransformFeedbackVaryings PFNGLTRANSFORMFEEDBACKVARYINGSPROC "typedef void (APIENTRYP PFNGLTRANSFORMFEEDBACKVARYINGSPROC) (GLuint program, GLsizei count, const GLchar* *varyings, GLenum bufferMode);")
...
(define-entry-point glVertexAttribIPointer PFNGLVERTEXATTRIBIPOINTERPROC "typedef void (APIENTRYP PFNGLVERTEXATTRIBIPOINTERPROC) (GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);")
...
(define-entry-point glDrawArraysInstanced PFNGLDRAWARRAYSINSTANCEDPROC "typedef void (APIENTRYP PFNGLDRAWARRAYSINSTANCEDPROC) (GLenum mode, GLint first, GLsizei count, GLsizei primcount);")
(define-entry-point glDrawElementsInstanced PFNGLDRAWELEMENTSINSTANCEDPROC "typedef void (APIENTRYP PFNGLDRAWELEMENTSINSTANCEDPROC) (GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLsizei primcount);")
...
(define-entry-point glMinSampleShading PFNGLMINSAMPLESHADINGPROC "typedef void (APIENTRYP PFNGLMINSAMPLESHADINGPROC) (GLclampf value);")
...
(define-entry-point glDrawElementsInstancedARB PFNGLDRAWELEMENTSINSTANCEDARBPROC "typedef void (APIENTRYP PFNGLDRAWELEMENTSINSTANCEDARBPROC) (GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLsizei primcount);")
...
(define-entry-point glMapBufferRange PFNGLMAPBUFFERRANGEPROC "typedef GLvoid* (APIENTRYP PFNGLMAPBUFFERRANGEPROC) (GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);")
...
(define-entry-point glGetUniformIndices PFNGLGETUNIFORMINDICESPROC "typedef void (APIENTRYP PFNGLGETUNIFORMINDICESPROC) (GLuint program, GLsizei uniformCount, const GLchar* *uniformNames, GLuint *uniformIndices);")
...
(define-entry-point glDrawElementsBaseVertex PFNGLDRAWELEMENTSBASEVERTEXPROC "typedef void (APIENTRYP PFNGLDRAWELEMENTSBASEVERTEXPROC) (GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLint basevertex);")
(define-entry-point glDrawRangeElementsBaseVertex PFNGLDRAWRANGEELEMENTSBASEVERTEXPROC "typedef void (APIENTRYP PFNGLDRAWRANGEELEMENTSBASEVERTEXPROC) (GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid *indices, GLint basevertex);")
(define-entry-point glDrawElementsInstancedBaseVertex PFNGLDRAWELEMENTSINSTANCEDBASEVERTEXPROC "typedef void (APIENTRYP PFNGLDRAWELEMENTSINSTANCEDBASEVERTEXPROC) (GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLsizei primcount, GLint basevertex);")
(define-entry-point glMultiDrawElementsBaseVertex PFNGLMULTIDRAWELEMENTSBASEVERTEXPROC "typedef void (APIENTRYP PFNGLMULTIDRAWELEMENTSBASEVERTEXPROC) (GLenum mode, const GLsizei *count, GLenum type, const GLvoid* *indices, GLsizei primcount, const GLint *basevertex);")
...
(define-entry-point glGetInteger64v PFNGLGETINTEGER64VPROC "typedef void (APIENTRYP PFNGLGETINTEGER64VPROC) (GLenum pname, GLint64 *params);")
...
(define-entry-point glTexImage2DMultisample PFNGLTEXIMAGE2DMULTISAMPLEPROC "typedef void (APIENTRYP PFNGLTEXIMAGE2DMULTISAMPLEPROC) (GLenum target, GLsizei samples, GLint internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations);")
(define-entry-point glTexImage3DMultisample PFNGLTEXIMAGE3DMULTISAMPLEPROC "typedef void (APIENTRYP PFNGLTEXIMAGE3DMULTISAMPLEPROC) (GLenum target, GLsizei samples, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations);")
...
(define-entry-point glSampleMaski PFNGLSAMPLEMASKIPROC "typedef void (APIENTRYP PFNGLSAMPLEMASKIPROC) (GLuint index, GLbitfield mask);")
...
(define-entry-point glMinSampleShadingARB PFNGLMINSAMPLESHADINGARBPROC "typedef void (APIENTRYP PFNGLMINSAMPLESHADINGARBPROC) (GLclampf value);")
...
(define-entry-point glCompileShaderIncludeARB PFNGLCOMPILESHADERINCLUDEARBPROC "typedef void (APIENTRYP PFNGLCOMPILESHADERINCLUDEARBPROC) (GLuint shader, GLsizei count, const GLchar* *path, const GLint *length);")
...
(define-entry-point glDrawArraysIndirect PFNGLDRAWARRAYSINDIRECTPROC "typedef void (APIENTRYP PFNGLDRAWARRAYSINDIRECTPROC) (GLenum mode, const GLvoid *indirect);")
(define-entry-point glDrawElementsIndirect PFNGLDRAWELEMENTSINDIRECTPROC "typedef void (APIENTRYP PFNGLDRAWELEMENTSINDIRECTPROC) (GLenum mode, GLenum type, const GLvoid *indirect);")
...
(define-entry-point glShaderBinary PFNGLSHADERBINARYPROC "typedef void (APIENTRYP PFNGLSHADERBINARYPROC) (GLsizei count, const GLuint *shaders, GLenum binaryformat, const GLvoid *binary, GLsizei length);")
...
(define-entry-point glDepthRangef PFNGLDEPTHRANGEFPROC "typedef void (APIENTRYP PFNGLDEPTHRANGEFPROC) (GLclampf n, GLclampf f);")
(define-entry-point glClearDepthf PFNGLCLEARDEPTHFPROC "typedef void (APIENTRYP PFNGLCLEARDEPTHFPROC) (GLclampf d);")
(define-entry-point glGetProgramBinary PFNGLGETPROGRAMBINARYPROC "typedef void (APIENTRYP PFNGLGETPROGRAMBINARYPROC) (GLuint program, GLsizei bufSize, GLsizei *length, GLenum *binaryFormat, GLvoid *binary);")
(define-entry-point glProgramBinary PFNGLPROGRAMBINARYPROC "typedef void (APIENTRYP PFNGLPROGRAMBINARYPROC) (GLuint program, GLenum binaryFormat, const GLvoid *binary, GLsizei length);")
...
(define-entry-point glCreateShaderProgramv PFNGLCREATESHADERPROGRAMVPROC "typedef GLuint (APIENTRYP PFNGLCREATESHADERPROGRAMVPROC) (GLenum type, GLsizei count, const GLchar* *strings);")
...
(define-entry-point glVertexAttribLPointer PFNGLVERTEXATTRIBLPOINTERPROC "typedef void (APIENTRYP PFNGLVERTEXATTRIBLPOINTERPROC) (GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);")
...
(define-entry-point glDepthRangeArrayv PFNGLDEPTHRANGEARRAYVPROC "typedef void (APIENTRYP PFNGLDEPTHRANGEARRAYVPROC) (GLuint first, GLsizei count, const GLclampd *v);")
(define-entry-point glDepthRangeIndexed PFNGLDEPTHRANGEINDEXEDPROC "typedef void (APIENTRYP PFNGLDEPTHRANGEINDEXEDPROC) (GLuint index, GLclampd n, GLclampd f);")
...
(define-entry-point glDebugMessageCallbackARB PFNGLDEBUGMESSAGECALLBACKARBPROC "typedef void (APIENTRYP PFNGLDEBUGMESSAGECALLBACKARBPROC) (GLDEBUGPROCARB callback, const GLvoid *userParam);")
...
(define-entry-point glGetnColorTableARB PFNGLGETNCOLORTABLEARBPROC "typedef void (APIENTRYP PFNGLGETNCOLORTABLEARBPROC) (GLenum target, GLenum format, GLenum type, GLsizei bufSize, GLvoid *table);")
(define-entry-point glGetnConvolutionFilterARB PFNGLGETNCONVOLUTIONFILTERARBPROC "typedef void (APIENTRYP PFNGLGETNCONVOLUTIONFILTERARBPROC) (GLenum target, GLenum format, GLenum type, GLsizei bufSize, GLvoid *image);")
(define-entry-point glGetnSeparableFilterARB PFNGLGETNSEPARABLEFILTERARBPROC "typedef void (APIENTRYP PFNGLGETNSEPARABLEFILTERARBPROC) (GLenum target, GLenum format, GLenum type, GLsizei rowBufSize, GLvoid *row, GLsizei columnBufSize, GLvoid *column, GLvoid *span);")
(define-entry-point glGetnHistogramARB PFNGLGETNHISTOGRAMARBPROC "typedef void (APIENTRYP PFNGLGETNHISTOGRAMARBPROC) (GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, GLvoid *values);")
(define-entry-point glGetnMinmaxARB PFNGLGETNMINMAXARBPROC "typedef void (APIENTRYP PFNGLGETNMINMAXARBPROC) (GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, GLvoid *values);")
(define-entry-point glGetnTexImageARB PFNGLGETNTEXIMAGEARBPROC "typedef void (APIENTRYP PFNGLGETNTEXIMAGEARBPROC) (GLenum target, GLint level, GLenum format, GLenum type, GLsizei bufSize, GLvoid *img);")
(define-entry-point glReadnPixelsARB PFNGLREADNPIXELSARBPROC "typedef void (APIENTRYP PFNGLREADNPIXELSARBPROC) (GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLsizei bufSize, GLvoid *data);")
(define-entry-point glGetnCompressedTexImageARB PFNGLGETNCOMPRESSEDTEXIMAGEARBPROC "typedef void (APIENTRYP PFNGLGETNCOMPRESSEDTEXIMAGEARBPROC) (GLenum target, GLint lod, GLsizei bufSize, GLvoid *img);")
...
(define-entry-point glDrawArraysInstancedBaseInstance PFNGLDRAWARRAYSINSTANCEDBASEINSTANCEPROC "typedef void (APIENTRYP PFNGLDRAWARRAYSINSTANCEDBASEINSTANCEPROC) (GLenum mode, GLint first, GLsizei count, GLsizei primcount, GLuint baseinstance);")
(define-entry-point glDrawElementsInstancedBaseInstance PFNGLDRAWELEMENTSINSTANCEDBASEINSTANCEPROC "typedef void (APIENTRYP PFNGLDRAWELEMENTSINSTANCEDBASEINSTANCEPROC) (GLenum mode, GLsizei count, GLenum type, const void *indices, GLsizei primcount, GLuint baseinstance);")
...
(define-entry-point glDrawTransformFeedbackInstanced PFNGLDRAWTRANSFORMFEEDBACKINSTANCEDPROC "typedef void (APIENTRYP PFNGLDRAWTRANSFORMFEEDBACKINSTANCEDPROC) (GLenum mode, GLuint id, GLsizei primcount);")
(define-entry-point glDrawTransformFeedbackStreamInstanced PFNGLDRAWTRANSFORMFEEDBACKSTREAMINSTANCEDPROC "typedef void (APIENTRYP PFNGLDRAWTRANSFORMFEEDBACKSTREAMINSTANCEDPROC) (GLenum mode, GLuint id, GLuint stream, GLsizei primcount);")
...
(define-entry-point glGetQueryObjecti64vEXT PFNGLGETQUERYOBJECTI64VEXTPROC "typedef void (APIENTRYP PFNGLGETQUERYOBJECTI64VEXTPROC) (GLuint id, GLenum pname, GLint64EXT *params);")
(define-entry-point glGetQueryObjectui64vEXT PFNGLGETQUERYOBJECTUI64VEXTPROC "typedef void (APIENTRYP PFNGLGETQUERYOBJECTUI64VEXTPROC) (GLuint id, GLenum pname, GLuint64EXT *params);")
...
(define-entry-point glVertexAttribIPointerEXT PFNGLVERTEXATTRIBIPOINTEREXTPROC "typedef void (APIENTRYP PFNGLVERTEXATTRIBIPOINTEREXTPROC) (GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);")
...
(define-entry-point glDrawElementsInstancedEXT PFNGLDRAWELEMENTSINSTANCEDEXTPROC "typedef void (APIENTRYP PFNGLDRAWELEMENTSINSTANCEDEXTPROC) (GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLsizei primcount);")
...
(define-entry-point glProgramBufferParametersfvNV PFNGLPROGRAMBUFFERPARAMETERSFVNVPROC "typedef void (APIENTRYP PFNGLPROGRAMBUFFERPARAMETERSFVNVPROC) (GLenum target, GLuint buffer, GLuint index, GLsizei count, const GLfloat *params);")
(define-entry-point glProgramBufferParametersIivNV PFNGLPROGRAMBUFFERPARAMETERSIIVNVPROC "typedef void (APIENTRYP PFNGLPROGRAMBUFFERPARAMETERSIIVNVPROC) (GLenum target, GLuint buffer, GLuint index, GLsizei count, const GLint *params);")
(define-entry-point glProgramBufferParametersIuivNV PFNGLPROGRAMBUFFERPARAMETERSIUIVNVPROC "typedef void (APIENTRYP PFNGLPROGRAMBUFFERPARAMETERSIUIVNVPROC) (GLenum target, GLuint buffer, GLuint index, GLsizei count, const GLuint *params);")
...
(define-entry-point glTransformFeedbackAttribsNV PFNGLTRANSFORMFEEDBACKATTRIBSNVPROC "typedef void (APIENTRYP PFNGLTRANSFORMFEEDBACKATTRIBSNVPROC) (GLuint count, const GLint *attribs, GLenum bufferMode);")
...
(define-entry-point glTransformFeedbackVaryingsEXT PFNGLTRANSFORMFEEDBACKVARYINGSEXTPROC "typedef void (APIENTRYP PFNGLTRANSFORMFEEDBACKVARYINGSEXTPROC) (GLuint program, GLsizei count, const GLchar* *varyings, GLenum bufferMode);")
...
(define-entry-point glTextureImage1DEXT PFNGLTEXTUREIMAGE1DEXTPROC "typedef void (APIENTRYP PFNGLTEXTUREIMAGE1DEXTPROC) (GLuint texture, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const GLvoid *pixels);")
(define-entry-point glTextureImage2DEXT PFNGLTEXTUREIMAGE2DEXTPROC "typedef void (APIENTRYP PFNGLTEXTUREIMAGE2DEXTPROC) (GLuint texture, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels);")
(define-entry-point glTextureSubImage1DEXT PFNGLTEXTURESUBIMAGE1DEXTPROC "typedef void (APIENTRYP PFNGLTEXTURESUBIMAGE1DEXTPROC) (GLuint texture, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const GLvoid *pixels);")
(define-entry-point glTextureSubImage2DEXT PFNGLTEXTURESUBIMAGE2DEXTPROC "typedef void (APIENTRYP PFNGLTEXTURESUBIMAGE2DEXTPROC) (GLuint texture, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels);")
...
(define-entry-point glGetTextureImageEXT PFNGLGETTEXTUREIMAGEEXTPROC "typedef void (APIENTRYP PFNGLGETTEXTUREIMAGEEXTPROC) (GLuint texture, GLenum target, GLint level, GLenum format, GLenum type, GLvoid *pixels);")
...
(define-entry-point glTextureImage3DEXT PFNGLTEXTUREIMAGE3DEXTPROC "typedef void (APIENTRYP PFNGLTEXTUREIMAGE3DEXTPROC) (GLuint texture, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const GLvoid *pixels);")
(define-entry-point glTextureSubImage3DEXT PFNGLTEXTURESUBIMAGE3DEXTPROC "typedef void (APIENTRYP PFNGLTEXTURESUBIMAGE3DEXTPROC) (GLuint texture, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const GLvoid *pixels);")
...
(define-entry-point glMultiTexImage1DEXT PFNGLMULTITEXIMAGE1DEXTPROC "typedef void (APIENTRYP PFNGLMULTITEXIMAGE1DEXTPROC) (GLenum texunit, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const GLvoid *pixels);")
(define-entry-point glMultiTexImage2DEXT PFNGLMULTITEXIMAGE2DEXTPROC "typedef void (APIENTRYP PFNGLMULTITEXIMAGE2DEXTPROC) (GLenum texunit, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels);")
(define-entry-point glMultiTexSubImage1DEXT PFNGLMULTITEXSUBIMAGE1DEXTPROC "typedef void (APIENTRYP PFNGLMULTITEXSUBIMAGE1DEXTPROC) (GLenum texunit, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const GLvoid *pixels);")
(define-entry-point glMultiTexSubImage2DEXT PFNGLMULTITEXSUBIMAGE2DEXTPROC "typedef void (APIENTRYP PFNGLMULTITEXSUBIMAGE2DEXTPROC) (GLenum texunit, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels);")
...
(define-entry-point glGetMultiTexImageEXT PFNGLGETMULTITEXIMAGEEXTPROC "typedef void (APIENTRYP PFNGLGETMULTITEXIMAGEEXTPROC) (GLenum texunit, GLenum target, GLint level, GLenum format, GLenum type, GLvoid *pixels);")
...
(define-entry-point glMultiTexImage3DEXT PFNGLMULTITEXIMAGE3DEXTPROC "typedef void (APIENTRYP PFNGLMULTITEXIMAGE3DEXTPROC) (GLenum texunit, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const GLvoid *pixels);")
(define-entry-point glMultiTexSubImage3DEXT PFNGLMULTITEXSUBIMAGE3DEXTPROC "typedef void (APIENTRYP PFNGLMULTITEXSUBIMAGE3DEXTPROC) (GLenum texunit, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const GLvoid *pixels);")
...
(define-entry-point glMultiTexCoordPointerEXT PFNGLMULTITEXCOORDPOINTEREXTPROC "typedef void (APIENTRYP PFNGLMULTITEXCOORDPOINTEREXTPROC) (GLenum texunit, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);")
...
(define-entry-point glGetPointerIndexedvEXT PFNGLGETPOINTERINDEXEDVEXTPROC "typedef void (APIENTRYP PFNGLGETPOINTERINDEXEDVEXTPROC) (GLenum target, GLuint index, GLvoid* *data);")
(define-entry-point glCompressedTextureImage3DEXT PFNGLCOMPRESSEDTEXTUREIMAGE3DEXTPROC "typedef void (APIENTRYP PFNGLCOMPRESSEDTEXTUREIMAGE3DEXTPROC) (GLuint texture, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const GLvoid *bits);")
(define-entry-point glCompressedTextureImage2DEXT PFNGLCOMPRESSEDTEXTUREIMAGE2DEXTPROC "typedef void (APIENTRYP PFNGLCOMPRESSEDTEXTUREIMAGE2DEXTPROC) (GLuint texture, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const GLvoid *bits);")
(define-entry-point glCompressedTextureImage1DEXT PFNGLCOMPRESSEDTEXTUREIMAGE1DEXTPROC "typedef void (APIENTRYP PFNGLCOMPRESSEDTEXTUREIMAGE1DEXTPROC) (GLuint texture, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const GLvoid *bits);")
...
(define-entry-point glCompressedTextureSubImage2DEXT PFNGLCOMPRESSEDTEXTURESUBIMAGE2DEXTPROC "typedef void (APIENTRYP PFNGLCOMPRESSEDTEXTURESUBIMAGE2DEXTPROC) (GLuint texture, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const GLvoid *bits);")
(define-entry-point glCompressedTextureSubImage1DEXT PFNGLCOMPRESSEDTEXTURESUBIMAGE1DEXTPROC "typedef void (APIENTRYP PFNGLCOMPRESSEDTEXTURESUBIMAGE1DEXTPROC) (GLuint texture, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const GLvoid *bits);")
(define-entry-point glGetCompressedTextureImageEXT PFNGLGETCOMPRESSEDTEXTUREIMAGEEXTPROC "typedef void (APIENTRYP PFNGLGETCOMPRESSEDTEXTUREIMAGEEXTPROC) (GLuint texture, GLenum target, GLint lod, GLvoid *img);")
...
(define-entry-point glCompressedMultiTexImage2DEXT PFNGLCOMPRESSEDMULTITEXIMAGE2DEXTPROC "typedef void (APIENTRYP PFNGLCOMPRESSEDMULTITEXIMAGE2DEXTPROC) (GLenum texunit, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const GLvoid *bits);")
(define-entry-point glCompressedMultiTexImage1DEXT PFNGLCOMPRESSEDMULTITEXIMAGE1DEXTPROC "typedef void (APIENTRYP PFNGLCOMPRESSEDMULTITEXIMAGE1DEXTPROC) (GLenum texunit, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const GLvoid *bits);")
(define-entry-point glCompressedMultiTexSubImage3DEXT PFNGLCOMPRESSEDMULTITEXSUBIMAGE3DEXTPROC "typedef void (APIENTRYP PFNGLCOMPRESSEDMULTITEXSUBIMAGE3DEXTPROC) (GLenum texunit, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const GLvoid *bits);")
(define-entry-point glCompressedMultiTexSubImage2DEXT PFNGLCOMPRESSEDMULTITEXSUBIMAGE2DEXTPROC "typedef void (APIENTRYP PFNGLCOMPRESSEDMULTITEXSUBIMAGE2DEXTPROC) (GLenum texunit, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const GLvoid *bits);")
(define-entry-point glCompressedMultiTexSubImage1DEXT PFNGLCOMPRESSEDMULTITEXSUBIMAGE1DEXTPROC "typedef void (APIENTRYP PFNGLCOMPRESSEDMULTITEXSUBIMAGE1DEXTPROC) (GLenum texunit, GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const GLvoid *bits);")
(define-entry-point glGetCompressedMultiTexImageEXT PFNGLGETCOMPRESSEDMULTITEXIMAGEEXTPROC "typedef void (APIENTRYP PFNGLGETCOMPRESSEDMULTITEXIMAGEEXTPROC) (GLenum texunit, GLenum target, GLint lod, GLvoid *img);")
(define-entry-point glNamedProgramStringEXT PFNGLNAMEDPROGRAMSTRINGEXTPROC "typedef void (APIENTRYP PFNGLNAMEDPROGRAMSTRINGEXTPROC) (GLuint program, GLenum target, GLenum format, GLsizei len, const GLvoid *string);")
...
(define-entry-point glGetNamedProgramStringEXT PFNGLGETNAMEDPROGRAMSTRINGEXTPROC "typedef void (APIENTRYP PFNGLGETNAMEDPROGRAMSTRINGEXTPROC) (GLuint program, GLenum target, GLenum pname, GLvoid *string);")
...
(define-entry-point glNamedBufferDataEXT PFNGLNAMEDBUFFERDATAEXTPROC "typedef void (APIENTRYP PFNGLNAMEDBUFFERDATAEXTPROC) (GLuint buffer, GLsizeiptr size, const GLvoid *data, GLenum usage);")
(define-entry-point glNamedBufferSubDataEXT PFNGLNAMEDBUFFERSUBDATAEXTPROC "typedef void (APIENTRYP PFNGLNAMEDBUFFERSUBDATAEXTPROC) (GLuint buffer, GLintptr offset, GLsizeiptr size, const GLvoid *data);")
(define-entry-point glMapNamedBufferEXT PFNGLMAPNAMEDBUFFEREXTPROC "typedef GLvoid* (APIENTRYP PFNGLMAPNAMEDBUFFEREXTPROC) (GLuint buffer, GLenum access);")
...
(define-entry-point glMapNamedBufferRangeEXT PFNGLMAPNAMEDBUFFERRANGEEXTPROC "typedef GLvoid* (APIENTRYP PFNGLMAPNAMEDBUFFERRANGEEXTPROC) (GLuint buffer, GLintptr offset, GLsizeiptr length, GLbitfield access);")
...
(define-entry-point glGetNamedBufferPointervEXT PFNGLGETNAMEDBUFFERPOINTERVEXTPROC "typedef void (APIENTRYP PFNGLGETNAMEDBUFFERPOINTERVEXTPROC) (GLuint buffer, GLenum pname, GLvoid* *params);")
(define-entry-point glGetNamedBufferSubDataEXT PFNGLGETNAMEDBUFFERSUBDATAEXTPROC "typedef void (APIENTRYP PFNGLGETNAMEDBUFFERSUBDATAEXTPROC) (GLuint buffer, GLintptr offset, GLsizeiptr size, GLvoid *data);")
...
(define-entry-point glGetPerfMonitorCounterInfoAMD PFNGLGETPERFMONITORCOUNTERINFOAMDPROC "typedef void (APIENTRYP PFNGLGETPERFMONITORCOUNTERINFOAMDPROC) (GLuint group, GLuint counter, GLenum pname, GLvoid *data);")
...
(define-entry-point glTextureRangeAPPLE PFNGLTEXTURERANGEAPPLEPROC "typedef void (APIENTRYP PFNGLTEXTURERANGEAPPLEPROC) (GLenum target, GLsizei length, const GLvoid *pointer);")
(define-entry-point glGetTexParameterPointervAPPLE PFNGLGETTEXPARAMETERPOINTERVAPPLEPROC "typedef void (APIENTRYP PFNGLGETTEXPARAMETERPOINTERVAPPLEPROC) (GLenum target, GLenum pname, GLvoid* *params);")
...
(define-entry-point glVertexAttribLPointerEXT PFNGLVERTEXATTRIBLPOINTEREXTPROC "typedef void (APIENTRYP PFNGLVERTEXATTRIBLPOINTEREXTPROC) (GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);")
...
(define-entry-point glDebugMessageCallbackAMD PFNGLDEBUGMESSAGECALLBACKAMDPROC "typedef void (APIENTRYP PFNGLDEBUGMESSAGECALLBACKAMDPROC) (GLDEBUGPROCAMD callback, GLvoid *userParam);")
...
(define-entry-point glVDPAUInitNV PFNGLVDPAUINITNVPROC "typedef void (APIENTRYP PFNGLVDPAUINITNVPROC) (const GLvoid *vdpDevice, const GLvoid *getProcAddress);")
(define-entry-point glVDPAUFiniNV PFNGLVDPAUFININVPROC "typedef void (APIENTRYP PFNGLVDPAUFININVPROC) (void);")
(define-entry-point glVDPAURegisterVideoSurfaceNV PFNGLVDPAUREGISTERVIDEOSURFACENVPROC "typedef GLvdpauSurfaceNV (APIENTRYP PFNGLVDPAUREGISTERVIDEOSURFACENVPROC) (GLvoid *vdpSurface, GLenum target, GLsizei numTextureNames, const GLuint *textureNames);")
(define-entry-point glVDPAURegisterOutputSurfaceNV PFNGLVDPAUREGISTEROUTPUTSURFACENVPROC "typedef GLvdpauSurfaceNV (APIENTRYP PFNGLVDPAUREGISTEROUTPUTSURFACENVPROC) (GLvoid *vdpSurface, GLenum target, GLsizei numTextureNames, const GLuint *textureNames);")
(define-entry-point glVDPAUIsSurfaceNV PFNGLVDPAUISSURFACENVPROC "typedef void (APIENTRYP PFNGLVDPAUISSURFACENVPROC) (GLvdpauSurfaceNV surface);")
...
(define-entry-point glMultiDrawArraysIndirectAMD PFNGLMULTIDRAWARRAYSINDIRECTAMDPROC "typedef void (APIENTRYP PFNGLMULTIDRAWARRAYSINDIRECTAMDPROC) (GLenum mode, const GLvoid *indirect, GLsizei primcount, GLsizei stride);")
(define-entry-point glMultiDrawElementsIndirectAMD PFNGLMULTIDRAWELEMENTSINDIRECTAMDPROC "typedef void (APIENTRYP PFNGLMULTIDRAWELEMENTSINDIRECTAMDPROC) (GLenum mode, GLenum type, const GLvoid *indirect, GLsizei primcount, GLsizei stride);")
